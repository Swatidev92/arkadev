						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$cell1?>" cellpadding="1" border="0" class="devicewidth" modulebg="edit" style="background:#fff;">
								...
								<?php if($proposal_type!=5 && $proposal_type!=6 && $proposal_type!=7){ ?>
									...
									<?php 
									$obj_inverter = json_decode($cms->getSingleResult("SELECT content FROM #_customer_price_manager where field_const='inverter_types' and id='$inverter_type' "),true);
									...
									<?php 
										$obj_inverter = json_decode($cms->getSingleResult("SELECT content FROM #_customer_price_manager where field_const='inverter_types' and id='$inverter_type2' "),true);
