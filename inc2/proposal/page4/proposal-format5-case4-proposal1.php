									...
									<tr>
										...
										<td width="50%" style="text-align:center;">
											<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
												<tbody>
													<tr>
														<td style="text-align:left; width:20%;">Mottagare:</td>
														<td style="text-align:left; width:80%;"><?=$customer_name?>, <?=$proposal_address?></td>
													</tr>
												</tbody>
											</table>
										</td>
					...
					<tr>
						<td style="width: 100%;">
							<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background-color:#eee">
								<tbody>
									<tr>
										<td width="25%" valign="middle" style="text-align:center;font-size:18px;border:none; color:#000;">
											Betalningsvillkor:
										</td>
										<td width="20%" valign="middle" style="text-align:center;font-size:18px;border:none; color:#000;">
											10 dagar netto
										</td>
										<td width="55%" valign="middle" style="text-align:center;font-size:18px;border:none; color:#000;">
						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$cell1?>" cellpadding="1" border="0" class="devicewidth" modulebg="edit" style="background:#fff;">
								...
								<?php } ?>
									...
									<?php } else { ?>
									<tr>
										<td style="text-align:left;font-size:12px;">Kabellängd mellan växelriktare och Växelriktare and Fasadmätarskåp / Elcentral</td>
										<td style="text-align:center;font-size:12px;">10</td>
										<td style="text-align:center;font-size:12px;">m</td>
									</tr>
									<?php }}?>
						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$textspacing?>" cellpadding="<?=$textpadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									...
									<tr>
										<td style="text-align:left; font-size:12px;">**Grönt avdrag är 20% av totalbelopp menomfattar enbart material & arbetskostnader. Schablon är satt av Skatteverket till 14,55%. För mer information om bidraget och dess villkor, läs mer på <a href="https://www.skatteverket.se/">www.skatteverket.se</a></td>
									</tr>
										<?php } } ?>
									<?php if($charger_name!=''){
										if($proposal_customer_type==1){?>
