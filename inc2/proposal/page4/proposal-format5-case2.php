		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$cell1?>" cellpadding="1" border="0" class="devicewidth" modulebg="edit" style="background:#fff;">
								...
								<?php } ?>
									...
									<?php } ?>
									<!-- S:mk-19 -->
									<?php if($proposal_type==1 || $proposal_type==8 || $proposal_type==9 || $proposal_type==11) { if($otherDetailsArr['cable_len_inv']!= null ||$otherDetailsArr['cable_len_inv']!= "" ){?>
									<tr>
					...
					<?php if($charger_name!=''){?>
					<?php if($proposal_type==2 && $load_balancer==0){ ?>
					<tr><td></td></tr>
					<?php } ?>
					<tr>
						<td>
