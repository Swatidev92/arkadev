		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
					...
					if($load_balancer==1){
						$pris_text_heading = ', billaddare, batteri och lastbalanserare';
					}else{
						$pris_text_heading = ', billaddare och batteri';
					}
					?>
								...
								<tbody>
									<tr>
										...
										<td style="text-align:left; font-size:12px; width:30%;">
											<?php $price_excluding_vat = $price_excluding_vat + $charger_price_excluding_vat + $battery_price_excluding_vat;
									...
									<tr>
										...
										<td style="text-align:left; font-size:12px; <?=$bold?>; width:30%;">
											<?php $price_including_vat = $price_including_vat + $charger_price_including_vat + $battery_price_including_vat;
							...
							<table width="100%" align="center" cellspacing="<?=$cellspacing?>" cellpadding="<?=$cellpadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff; border-top: 1px solid #000;">
								<tbody>
									<tr>
										...
										<td style="text-align:left; font-size:12px; width:30%;">
											<?php $price_after_green_deduction = $price_after_green_deduction + $charger_price_after_green_deduction + $battery_price_after_green_deduction;
