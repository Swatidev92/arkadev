											...
											<table class="email_table" cellpadding="2" style="border-collapse: collapse; width: 100%;" border="0">
												<tbody>
													...
													<tr>
														...
														<td valign="middle" style="text-align:left;font-size:12px;border:none; width:70%;">
															<?=$number_of_proposal==2?$customer_name2:$customer_name?>
														</td>
													</tr>
													<?php
								...
								<tbody>
									<tr>
										...
										<td style="color:#000; text-align:left; width:30%;">											
											...
											}?> SEK<br><span style="font-size:14px;">
											<?php if($proposal_customer_type==2){?>
											Pris exklusive moms
											<?php }else{
												echo 'Pris efter grönt avdrag*';
											} ?></span></p>
										</td>
										...
										<td style="color:#000; text-align:left; width:30%;">
											<p style="font-size:28px; margin:0;"><?=$repayment_period?> år<br><span style="font-size:14px;">Återbetalningstid</span></p>
										</td>
									</tr>
									<tr>
										<td style=" color:#000; text-align:right; width:20%;">
										...
										<td style=" color:#000; text-align:left;width:30%;">	
											<p style="font-size:28px;"><?=amount_format_proposal($annual_production)?><br><span style="font-size:14px;">Årlig produktion (kWh)</span></p>
										</td>
										<td style=" color:#000; text-align:right; width:20%;">
											<img src="<?=SITE_PATH?>assets/images/pdf-icons/icon1.png" width="80">
										</td>
										<td style=" color:#000; text-align:left; width:30%;">
											<p style="font-size:28px;"><?=$solar_effect_warranty?> år<br><span style="font-size:14px;">Garanti</span></p>
										</td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									<tr>
										<td width="50%" style="text-align:center;">										   
										   <table width="100%" align="center" cellspacing="0" cellpadding="1" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
												<tbody>
													<tr>
													...
													<tr style="padding:10px">
														<td valign="middle" class="brand-warranty">
															Antal paneler:
														</td>
														<td valign="middle" class="brand-warranty">
															<?=$panel_count?>
													...
													<tr>
														...
														<td valign="middle" class="brand-warranty">
															<?php $ids = getids($sensor_type_name);
																	// print_r($ids);die;
																$sensor_type_name = json_decode($ids['content'],true);
																foreach($sensor_type_name as $cval){
													...
													<tr>
														...
														<td valign="middle" class="brand-warranty">
															<?php $ids = getids($odrift_type_name);
																	// print_r($ids);die;
																$odrift_type_name = json_decode($ids['content'],true);
																foreach($odrift_type_name as $cval){
													...
													<tr>
														...
														<td valign="middle" class="brand-warranty">
															<?php $ids = getids($optimizer_type_name);
																	// print_r($ids);die;
																$optimizer_type_name = json_decode($ids['content'],true);
																foreach($optimizer_type_name as $cval){
										...
										<td width="50%" style="text-align:center;">										   
										   <table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
												<tbody>
													...
													<tr>
														<td valign="middle" class="brand-name-warranty-left">
															Leverantör solceller:
														</td>
														<td valign="middle" class="brand-name-warranty-right">
													...
													<tr>
														<td valign="middle" class="brand-name-warranty-left">
															Produktgaranti Smart sensor:
														</td>
														<td valign="middle" class="brand-name-warranty-right">
															<?=$sensor_type_warranty?> år
														</td>
													</tr>
													<?php } ?>
													<?php if($odrift_type_name){?>
													<tr>
														<td valign="middle" class="brand-name-warranty-left">
															Produktgaranti Backup Box:
														</td>
														<td valign="middle" class="brand-name-warranty-right">
															<?=$odrift_type_warranty?> år
														</td>
													</tr>
													<?php } ?>
													<?php if($optimizer_type_name){?>
													<tr>
														<td valign="middle" class="brand-name-warranty-left">
															Produktgaranti Optimizer:
														</td>
														<td valign="middle" class="brand-name-warranty-right">
															<?=$optimizer_type_warranty?> år
														</td>
													</tr>
													<?php } ?>
												</tbody>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="<?=$textspacing?>" cellpadding="<?=$textpadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								...
								<tbody>
									<!--<tr>
										<td style="text-align:left; font-size:11px;">* Priset baseras på ett hushåll med två personer som kan nyttja det gröna avdraget till fullo. Se villkor för fullständig information.</td>
									</tr>-->
								</tbody>
							</table>
						</td>
