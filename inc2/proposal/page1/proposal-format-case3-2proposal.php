							...
							<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" modulebg="edit" style="background-color:#eee;">
								<tbody>
									<tr>
										...
										$proposal_total_cost = $proposal_total_cost-$battery_price_after_green_deduction - $charger_price_after_green_deduction - $load_price_after_green_deduction;
										
										?>
										<td style="color:#000; text-align:left; width:<?=$tdwidth?>%;">											
											<p style="font-size:30px; margin:0">
											<?php if($proposal_customer_type==2){
												$total_price_excluding_vat = $total_price_excluding_vat-$charger_price_excluding_vat - $battery_price_excluding_vat - $load_price_excluding_vat;
