...
$roofFetchDetailsQry = $cms->db_query("SELECT * FROM #_roof_details where proposal_id='".$_REQUEST['order_no']."' AND status=0 AND `form_type` != 'customer' AND is_deleted=0 ");
$k =1;
...
<html>
	<head>
		...
		<style type="text/css">
         ...
         table td {border-collapse: collapse; font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #000; text-align:left;line-height: 15px;padding:0px 10px}
		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
						...
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									...
									<!-- <tr>
										<td valign="middle" colspan="4" style="text-align:center;font-size:15px;border:none; padding:15px;">
					...
					<tr><td></td></tr>
					<tr><td></td></tr> -->
					<?php $border_btm = 'border-bottom: 1px solid #000'; } ?>
					<?php //} ?>
					<!--<tr>
						<td style="width: 100%;">
					...
					<tr style="">
						...
						<td width="25%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" class="devicewidth" modulebg="edit" style="background:#ffffff; <?=$border_btm?>">
								<tbody>
									<tr>
					...
					<!-- <tr style="border-bottom: 1px solid #000;"> -->
						...
						<td width="25%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff; <?=$border_btm?>">
								<tbody>
									<tr>
										<td valign="middle" style="text-align:center;font-size:15px;border:none; color:#22914f;">
											Växelriktare 2
