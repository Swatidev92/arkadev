		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
					...
					<!--<tr>
						<td style="width: 100%;">
							<table class="" cellpadding="10" style="border-collapse: collapse; width: 100%; background-color:#eee;" border="0">
								<tbody>
									<tr>
						...
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#fff; border-top: 1px solid #000;">
								<tbody>
									<tr>
										<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:15px; width:70%;">
											<b>Pris solcellsanläggning efter 14,55% Grönt Avdrag*</b>
										</td>
										<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:15px; width:30%;">
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="10" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff">
								<tbody>
									<tr>
										<td style="color:#fff; text-align:left;">
										   <p style="color:#22914f">*Grönt avdrag är 15% av totalbelopp men omfattar enbart material & arbetskostnader. Schablon är satt av Skatteverket till 14,55%. För mer  nformation om bidraget och dess villkor, läs mer på www.skatteverket.se</p>
										</td>
									</tr>
								</tbody>
							</table>
									...
									<tr>
										<td width="100%" style="text-align:center;">										   
										   <table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
												<tbody>
													<tr>
														<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:25px; width:70%;">
															Årlig elförbrukning i fastighet:
														</td>
														<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:25px; width:30%;">
															<?=amount_format_proposal($annual_electricity_consumption)?> kWh
														</td>
													</tr>
													<tr>
														<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:25px; width:70%;">
														...
														<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:25px; width:30%;">
															<?=amount_format_proposal($annual_production)?> kWh
														</td>
													</tr>
													<tr>
														<td valign="middle" style="text-align:left;font-size:16px;border:none; padding:25px; width:70%;">
