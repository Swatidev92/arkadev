...
<div class="row">
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<div class="clearfix"></div>
			<div class="form-group col-md-6">
				<label class="control-label">Product warranty solar cells</label>
				<input type="text" class="form-control" name="warranty_solar" value="<?=$warranty_solar?>" placeholder="Product warranty solar cells">
			</div>
			<div class="form-group col-md-6">
				<label class="control-label">Product warranty inverter</label>
				<input type="text" class="form-control" name="warranty_inverter" value="<?=$warranty_inverter?>" placeholder="Product warranty inverter">
			</div>
			<div class="clearfix"></div>
			<div class="form-group col-md-6">
				<label class="control-label">Product guarantee mounting system</label>
			...
			<div class="form-group col-md-6">
				<label class="control-label">Power guarantee solar cells after 30 years</label>
