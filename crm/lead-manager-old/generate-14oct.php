...
$(function(){
       $.post("https://arkaenergy.se/arkachart",{ svg: dataString }, function(data){
           //alert(data);
		   imageURL = data;
		//alert();
		//location.href="<?=SITE_PATH_ADM.CPAGE?>/generate-pdf.php?pid=<?=$lead_insert_id?>";
			location.href="https://arkaenergy.se/arka-admin/lead-manager/generate-pdf.php?pid=<?=$lead_insert_id?>";
       });
    });
