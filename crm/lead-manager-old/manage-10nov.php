						...
						<tr class="clickable-row">
							...
							<td class="text-nowrap">
								<?php
								 ...
								 <a href="<?=SITE_PATH_ADM.CPAGE?>?mode=add-proposal&id=<?=$id?>" data-toggle="tooltip" title="Edit Proposal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
								<?php if($proposal_pdf){?>&nbsp;&nbsp;
								 <a href="<?=SITE_PATH.'uploaded_files/proposal/'.$proposal_pdf?>" title="Download PDF" download><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
								 <?php } ?>&nbsp;&nbsp;
