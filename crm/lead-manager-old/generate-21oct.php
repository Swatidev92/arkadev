...
if($_FILES["installation_image"]["name"]){ 
	...
	$payback_table .='<tr>
							...
							<td style="text-align:center;">'.round($_POST['annual_production']).' kWh</td>
							<td style="text-align:center;">'.round($total_annual_saving).' kr</td>
							<td style="text-align:center;">'.number_format($return_percentage,2).'%</td>
							<td style="text-align:center;">'.round($left_amount).' kr</td>
						</tr>';	
	...
	$payback_table .='<tr>
							...
							<td style="text-align:center;">'.round($next_year_annual_prod).' kWh</td>
							<td style="text-align:center;">'.round($total_annual_saving).' kr</td>
							<td style="text-align:center;">'.number_format($return_percentage,2).'%</td>
							<td style="text-align:center;">'.round($left_amount).' kr</td>
						</tr>';	
