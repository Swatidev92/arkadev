...
<div class="row">
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<div class="form-group col-md-3">
				<label class="control-label">Panel Area (AA x BB m,CC x DD m)</label>
			...
			<div class="form-group col-md-12">
				<label class="label-control">The system is connected to the property's electrical exchange and installed according to the picture below.<br>(570px X 330px and should be less than 1 MB)</label>
			</div>
			<div class="form-group col-md-6">
				<div>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" name="issued_by" placeholder="Issued by" value="<?=$issued_by?$issued_by:'Arka Energy'?>">
			</div>
			<div class="form-group col-md-6">
