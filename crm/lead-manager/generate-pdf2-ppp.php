...
// set font
	...
	//$pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.2, 'depth_h'=>0.2, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
		...
		*/
		...
		if(($number_of_proposal==2 && $proposal_type==4) || ($number_of_proposal==2 && $proposal_type==10) || ($number_of_proposal==2 && $proposal_type==11)){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case4-proposal2.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==2 && $proposal_type==3){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case3-proposal2.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==3){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case3-proposal1.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==4){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case4-proposal1.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($proposal_type==5){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case5-only-charger.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($proposal_type==6){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case6-only-battery.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($proposal_type==7){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case7-only-battery-charger.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==8){
			$context  = stream_context_create($opts);
			$html1=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case8.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html1, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==2 && $proposal_type==8){
			$context  = stream_context_create($opts);
			$html1=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case8-proposal1.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html1, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==9){
			$context  = stream_context_create($opts);
			$html1=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case9.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html1, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==10){
			$context  = stream_context_create($opts);
			$html1=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case10.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html1, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($number_of_proposal==1 && $proposal_type==11){
			$context  = stream_context_create($opts);
			$html1=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case11.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html1, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else if($proposal_type==2){
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5-case2.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
		else{
			$html5=file_get_contents(SITE_PATH."inc2/proposal/page4/proposal-format5.php", false, $context);
			$pdf->writeHTMLCell(0, 0, '', '0', $html5, 0, 1, 0, true, '', true);
			$pdf->AddPage();
		}
