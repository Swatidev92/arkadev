...
// other-details-07
$otherDetailsQry = $cms->db_query("SELECT * FROM #_other_details where lead_id='$pid' AND is_deleted=0 ");
    ...
    <div class="col-sm-12">
		<div class="white-box">
			<?php
				...
				$lnk3="#";
				if($leadid>0){
					$lnk1="?mode=add-proposal&start=&t=prop_details&leadid=".$leadid."&id=".$pid;
					$lnk3="?mode=add-proposal&start=&t=other_details&leadid=".$leadid."&id=".$pid;
					$lnk2="?mode=add-proposal&start=&t=roof_details&leadid=".$leadid."&id=".$pid;
				...
				<div role="tabpannel" class="tab-pane <?php echo $active1;?>" id="proj_info">
					...
					<!-- NEWGR -->
					<input type="hidden" class="form-control" name="person2_max_rebate" value="">
					<input type="hidden" class="form-control" name="person1_max_rebate" value="">
					...
					<div class="col-sm-12">
						...
						<table class="table table-striped1 table-hover1 table-bordered">
							<?php if($proposal_type==8 || $proposal_type==9 || $proposal_type==11){ 
								$sevbMaxstyle = "";
							}else{
								$sevbMaxstyle = "display:none";
							}?>
							<thead class="show-table-header" style="<?=$sevbMaxstyle?>">						
								<?php if(($proposal_type==8 || $proposal_type==9 || $proposal_type==11) && $leadid && $pid!=''){ 
									$showPerson = "";
								}else{
									$showPerson = "display:none";
								}
								?>
								<tr class="show-person-selection" style="<?=$showPerson?>">
									<?php if($proposal_type==8){
										$colspan = 3;
										$colspan2 = 3;
									}
									else if($proposal_type==9){
										$colspan = 2;
										$colspan2 = 2;
									}
									...
									<div class="form-check">
										<th id="persontype" colspan="<?=$colspan?>" class="text-center form-group"><input class="form-check-input" type="radio" name="number_of_person" id="number_of_person1" value="1" <?=$number_of_person==1?'checked':''?> required>
										<label class="form-check-label" for="number_of_person1">1 Person</label></th>
										
										<th class="text-center form-group" colspan="<?=$colspan2?>"><input class="form-check-input" type="radio" name="number_of_person" id="number_of_person2" value="2" <?=$number_of_person==2?'checked':''?> required>
										<label class="form-check-label" for="number_of_person2">2 Person</label></th>
									</div>
								</tr>
													
								<?php if($proposal_type==8 && $leadid && $pid!=''){ 
									$sevbMaxstyle = "";
								}else{
									$sevbMaxstyle = "display:none";
								}?>
								<tr class="show-max-sevb" style="<?=$sevbMaxstyle?>">
									<th class="text-center">Solar</th>
									<th class="text-center">Ev Charger</th>
									<th class="text-center">Battery</th>
									<th class="text-center">Solar</th>
									<th class="text-center">Ev Charger</th>
									<th class="text-center">Battery</th>
								</tr>
								<?php if($proposal_type==9 && $leadid && $pid!=''){ 
									$sevMaxstyle = "";
								}else{
									$sevMaxstyle = "display:none";
								}?>
								<tr class="show-max-sev" style="<?=$sevMaxstyle?>">
									<th class="text-center">Solar</th>
									<th class="text-center">Ev Charger</th>
									<th class="text-center">Solar</th>
									<th class="text-center">EV Charger</th>
								...
								<tr class="show-max-sb" style="<?=$sbMaxstyle?>">
									<th class="text-center">Solar</th>
									<th class="text-center">Battery</th>
									<th class="text-center">Solar</th>
									<th class="text-center">Battery</th>
							...
							<tbody>
								<?php if($proposal_type==1 && $leadid && $pid!=''){
									$solarMaxstyle = "";
								}else{
									$solarMaxstyle = "display:none";
								}
								?>
								<tr class="show-max-onlysolar" style="<?=$solarMaxstyle?>">
									<td>
										<?php if($max_solar_rebate=='' || $max_solar_rebate==0){
											if($obj_max_solar[0]->status==1){
												$max_solar_rebate = $obj_max_solar[0]->maxmargin;
											}else{
												$max_solar_rebate = 0;
											}
										}else{
											$max_solar_rebate = $max_solar_rebate;
										}?>
										<label class="control-label">Person 1</label>
										<input type="text" class="form-control" name="max_solar_rebate" value="<?=$max_solar_rebate?>">
									</td>
								</tr>
								
								<?php if($max_solar_ev_battery_person1_rebate=='' || $max_solar_ev_battery_person1_rebate==0){
									if($obj_max_solar_ev_battery[0]->sevbstatus==1){
										$max_solar_ev_battery_person1_rebate = $obj_max_solar_ev_battery[0]->maxsevbmargin;
									}else{
										$max_solar_ev_battery_person1_rebate = 0;
									}
								}else{
									$max_solar_ev_battery_person1_rebate = $max_solar_ev_battery_person1_rebate;
								}?>
								<input type="hidden" class="form-control" name="max_solar_ev_battery_person1_rebate" value="<?=$max_solar_ev_battery_person1_rebate?>">
								
								<?php if($max_solar_ev_person1_rebate=='' || $max_solar_ev_person1_rebate==0){
									if($obj_max_solar_ev[0]->sevstatus==1){
										$max_solar_ev_person1_rebate = $obj_max_solar_ev[0]->maxsevmargin;
									}else{
										$max_solar_ev_person1_rebate = 0;
									}
								}else{
									$max_solar_ev_person1_rebate = $max_solar_ev_person1_rebate;
								}?>
								<input type="hidden" class="form-control" name="max_solar_ev_person1_rebate" value="<?=$max_solar_ev_person1_rebate?>">
								
								<?php if($max_solar_battery_person1_rebate=='' || $max_solar_battery_person1_rebate==0){
								...
								<input type="hidden" class="form-control" name="max_solar_battery_person1_rebate" value="50000">
								...
								<tr class="show-person-selection" style="<?=$showPerson?>">
									...
									<td class="show_solar_max_rebate form-group" style="<?=$styles?>">
										<input type="number" class="form-control" name="person1_solar_max_rebate" value="<?=$person1_solar_max_rebate?>" min="0" max="50000">
									</td>
									<?php if($proposal_type==8 || $proposal_type==9){
										$stylec = '';
									}else{	
										$stylec = 'display:none';
									}?>
									<td class="show_charger_max_rebate form-group" style="<?=$stylec?>">
										<input type="number" class="form-control" name="person1_charger_max_rebate" value="<?=$person1_charger_max_rebate?>" min="0" max="<?=$obj_evchargermaxmrg[0]->maxrebate?>">
									</td>
									<?php if($proposal_type==8 || $proposal_type==11){
										$styleb = '';
									}else{	
										$styleb = 'display:none';
									}?>
									<td class="show_battery_max_rebate form-group" style="<?=$styleb?>">
										<input type="number" class="form-control" name="person1_battery_max_rebate" value="<?=$person1_battery_max_rebate?>" min="0" max="50000">
									</td>
									...
									?>
									<td class="show-max-sevb form-group" style="<?=$sevbMaxstyle?>">
										<?php if($max_sevb_solarev_person2_rebate=='' || $max_sevb_solarev_person2_rebate==0){
											if($obj_max_solar_ev_battery[0]->sevptwostatus==1){
												$max_sevb_solarev_person2_rebate = $obj_max_solar_ev_battery[0]->sevptwomaxmargin;
											}else{
												$max_sevb_solarev_person2_rebate = 0;
											}
										}else{
											$max_sevb_solarev_person2_rebate = $max_sevb_solarev_person2_rebate;
										}?>
										<input type="number" class="form-control" name="max_sevb_solar_person2_rebate" value="<?=$max_sevb_solar_person2_rebate?>" min="0" max="50000">
										<input type="hidden" class="form-control" name="max_sevb_solarev_person2_rebate" value="<?=$obj_max_solar_ev_battery[0]->sevptwomaxmargin?>">
									</td>
									<td class="show-max-sevb form-group" style="<?=$sevbMaxstyle?>">
										<?php if($max_sevb_charger_person2_rebate=='' || $max_sevb_charger_person2_rebate==0){
											if($obj_evchargermaxmrg[0]->status==1){
												$max_sevb_charger_person2_rebate = $obj_evchargermaxmrg[0]->maxrebate;
											}else{
												$max_sevb_charger_person2_rebate = 0;
											}
										}else{
											$max_sevb_charger_person2_rebate = $max_sevb_charger_person2_rebate;
										}?>
										<input type="number" class="form-control" name="max_sevb_charger_person2_rebate" value="<?=$max_sevb_charger_person2_rebate?>" min="0" max="<?=$obj_evchargermaxmrg[0]->maxrebate?>">
									</td>
									<td class="show-max-sevb form-group" style="<?=$sevbMaxstyle?>">								
										<?php if($max_sevb_battery_person2_rebate=='' || $max_sevb_battery_person2_rebate==0){
											if($obj_max_solar_ev_battery[0]->bptwostatus==1){
												$max_sevb_battery_person2_rebate = $obj_max_solar_ev_battery[0]->bptwomaxmargin;
											}else{
												$max_sevb_battery_person2_rebate = 0;
											}
										}else{
											$max_sevb_battery_person2_rebate = $max_sevb_battery_person2_rebate;
										}?>
										<input type="number" class="form-control" name="max_sevb_battery_person2_rebate" value="<?=$max_sevb_battery_person2_rebate?>" min="0" max="<?=$obj_max_solar_ev_battery[0]->bptwomaxmargin?>">
									</td>
									...
									?>
									<td class="show-max-sev form-group" style="<?=$sevMaxstyle?>">
										<?php if($max_sev_solar_person2_rebate=='' || $max_sev_solar_person2_rebate==0){
											if($obj_max_solar_ev[0]->sptwostatus==1){
												$max_sev_solar_person2_rebate = $obj_max_solar_ev[0]->sptwomaxmargin;
											}else{
												$max_sev_solar_person2_rebate = 0;
											}
										}else{
											$max_sev_solar_person2_rebate = $max_sev_solar_person2_rebate;
										}?>
										<input type="number" class="form-control" name="max_sev_solar_person2_rebate" value="<?=$max_sev_solar_person2_rebate?>" min="0" max="<?=$obj_max_solar_ev[0]->sptwomaxmargin?>">
									</td>
									<td class="show-max-sev form-group" style="<?=$sevMaxstyle?>">								
										<?php if($max_sev_charger_person2_rebate=='' || $max_sev_charger_person2_rebate==0){
											if($obj_max_solar_ev[0]->evptwostatus==1){
												$max_sev_charger_person2_rebate = $obj_max_solar_ev[0]->evptwomaxmargin;
											}else{
												$max_sev_charger_person2_rebate = 0;
											}
										}else{
											$max_sev_charger_person2_rebate = $max_sev_charger_person2_rebate;
										}?>
										<input type="number" class="form-control" name="max_sev_charger_person2_rebate" value="<?=$max_sev_charger_person2_rebate?>" min="0" max="<?=$obj_max_solar_ev[0]->evptwomaxmargin?>">
									</td>
									...
									<td class="show-max-sb form-group" style="<?=$sbMaxstyle?>">
										<?php if($max_solar_person2_rebate=='' || $max_solar_person2_rebate==0){
										...
										<input type="number" class="form-control" name="max_solar_person2_rebate" value="<?=$max_solar_person2_rebate?>" min="0" max="<?=$obj_max_solar_battery[0]->solarmaxmargin?>">
									</td>
									<td class="show-max-sb form-group" style="<?=$sbMaxstyle?>">								
										<?php if($max_battery_person2_rebate=='' || $max_battery_person2_rebate==0){
										...
										<input type="number" class="form-control" name="max_battery_person2_rebate" value="<?=$max_battery_person2_rebate?>" min="0" max="<?=$obj_max_solar_battery[0]->batterymaxmargin?>">
									</td>
								</tr>						
							</tbody>
						</table>
						...
						<div class="form-group">
							...
							<select class="form-control" id="sensor_type_name" name="sensor_type_name">
								...
								foreach ($sensorTypeArray as $snkey => $snvalue) {
									...
									if($sensor_type_name==$snvalue["sensor_name"] && ($leadid!='' && $pid!='')){
										$snsel = 'selected';
									}else{
										$snsel = '';
									}
						...
						<div class="form-group">
							...
							<select class="form-control" id="odrift_type_name" name="odrift_type_name">
								...
								foreach ($odriftTypeArray as $odkey => $odvalue) {
									...
									if($odrift_type_name==$odvalue["odrift_name"] && ($leadid!='' && $pid!='')){
										$snsel = 'selected';
									}else{
										$snsel = '';
									}
						...
						<div class="form-group">
							...
							<select class="form-control" id="optimizer_type_name" name="optimizer_type_name">
								...
								foreach ($optimizerTypeArray as $odkey => $odvalue) {
									...
									if($optimizer_type_name==$odvalue["optimizer_name"] && ($leadid!='' && $pid!='')){
										$snsel = 'selected';
									}else{
										$snsel = '';
									}
					...
					<div class="form-group col-md-3 show-charger-margin" style="<?=$stylem?>">
						...
						<input type="number" class="form-control" name="charger_margin" value="<?=($leadid!='' && $pid!='')?($charger_margin?$charger_margin:$cmargin):$cmargin?>" <?=$_SESSION["ses_adm_role"]==1?'':''?> min="<?=($_SESSION["ses_adm_role"]==1)?0:$cmargin?>">
					</div>
					<?php  if($proposal_type==3 || $proposal_type==4 || $proposal_type==6 || $proposal_type==7 || $proposal_type==8 || $proposal_type==10 || $proposal_type==11){
						$stylebm = '';
					}else{	
					...
					<div class="form-group col-md-3 show-battery-margin" style="<?=$stylebm?>">
						...
						<input type="number" class="form-control" name="battery_margin" value="<?=($leadid!='' && $pid!='')?($battery_margin?$battery_margin:$bmargin):$bmargin?>" <?=$_SESSION["ses_adm_role"]==1?'':''?> min="<?=($_SESSION["ses_adm_role"]==1)?0:$bmargin?>">
					</div>		
					<?php if($obj_btmrg[0]->status==1){
						$bmargin = $obj_btmrg[0]->margin;
						$binfo = '';
