				...
				<div role="tabpanel" class="tab-pane fade active in" id="eng">
					<div class="form-group">
							...
							<div class="panel">
								...
								<?php
									...
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
											Image dimension: 270px X 130px and extension: jpg
											<input type="file" name="evc[<?=$i?>][charger_img]" id="input-file-max-fs" class="dropify" data-max-file-size="1M" data-height="150" <?php if($val->charger_img AND file_exists(FILES_PATH.'proposal/charger/'.$val->charger_img)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/charger/<?=$val->charger_img?>" <?php } ?> />
							...
							<div class="panel">
								...
								<div class="col-xs-2 col-sm-2 col-md-2">
									...
									<!--<div class="col-xs-2 col-sm-2 col-md-2">
                                        <div class="form-group">
                                            Discount (kr)
                                            <input autocomplete="off" name="pty[<?=$i?>][sdiscount]" type="text" placeholder="Discount" class="form-control" value="<?=$val->sdiscount?>"/>
                                        </div>
                                    </div>-->
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
											Image dimension: 270px X 130px and extension: jpg
											<input type="file" name="pty[<?=$i?>][panel_img]" id="input-file-max-fs" class="dropify" data-max-file-size="1M" data-height="150" <?php if($val->panel_img AND file_exists(FILES_PATH.'proposal/solar-panel/'.$val->panel_img)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/solar-panel/<?=$val->panel_img?>" <?php } ?> />
							...
							<div class="panel">
								...
								<?php
									...
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
											Image dimension: 270px X 130px and extension: jpg
											<input type="file" name="invt[<?=$i?>][inverter_img]" id="input-file-max-fs" class="dropify" data-max-file-size="1M" data-height="150" <?php if($val->inverter_img AND file_exists(FILES_PATH.'proposal/inverter/'.$val->inverter_img)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/inverter/<?=$val->inverter_img?>" <?php } ?> />
							...
							<div class="panel">
								...
								<?php
									...
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
											Image dimension: 270px X 130px and extension: jpg
											<input type="file" name="btrcs[<?=$i?>][battery_img]" id="input-file-max-fs" class="dropify" data-max-file-size="1M" data-height="150" <?php if($val->battery_img AND file_exists(FILES_PATH.'proposal/battery/'.$val->battery_img)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/battery/<?=$val->battery_img?>" <?php } ?> />
						...
						<!--<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								<div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab"> 
									<a class="panel-title collapsed" data-toggle="collapse" href="#solarDiscountPercentage" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="solarDiscountPercentage">Discount</a> 
								</div>
								...
								<?php
										...
										$obj_bdis = json_decode($battery_discount);
										$i=0;
										?>
											<div class="col-xs-4 col-sm-4 col-md-4">

                                        <div class="form-group">
                                         Discount on battery (kr)
                                            <input name="bdis[<?=$i?>][discount]" type="text" placeholder="" class="form-control" value="<?=$obj_bdis[0]->discount?>"/>
										...
										$obj_cdis = json_decode($charger_discount);
										$i=0;
										?>
											<div class="col-xs-4 col-sm-4 col-md-4">

                                        <div class="form-group">
                                         Discount on charger (kr)
                                            <input name="cdis[<?=$i?>][discount]" type="text" placeholder="" class="form-control" value="<?=$obj_cdis[0]->discount?>"/>
							...
							<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
								<div class="panel">
									...
									<?php
											...
											$obj_vat = json_decode($vat_percentage);
											$i=0;
											?>
												<div class="col-xs-4 col-sm-4 col-md-4">
