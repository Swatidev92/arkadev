...
if($_GET['courseId']!=''){
	...
	if($action=='mdel'){
		...
		$path = SITE_PATH_ADM."help-category";
	$cms->redir($path, true);
		//exit;
	}
	...
	if($cms->is_post_back()){ 
		...
		if(!empty($_POST['edit_row'])){ 
			foreach($_POST['edit_row'] as $pid){
				...
				$_POST['content_title']=$_POST['content_title'];
        ...
        <div class="white-box">
			...
			<div class="show-course-content">
				<div class="form-group col-sm-6">
					...
					<input type="text" name="content_title" value="<?=$cStepRes['content_title']?>" class="form-control" id="content_title<?=$cStepRes['id']?>" placeholder="Content Title" data-fv-regexp="true" data-error="Please enter content title" required>
					<div class="help-block with-errors"></div>
				</div>				
			...
			<?php } ?>
			<div class="clearfix"></div>
			<?php if($cStepRes['uploaded_files']){ ?>
			<div class="show-file-upload">
				<div class="form-group col-sm-4">
					<label for="content_title" class="control-label">File Title</label>
					<input type="text" name="content_title" value="<?=$cStepRes['content_title']?>" class="form-control" id="content_title<?=$cStepRes['id']?>" placeholder="File Title" data-fv-regexp="true" data-error="Please enter file title" required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group col-sm-6">
					<label for="step_title" class="control-label">Upload (DOC, EXCEL, PPT, PDF, IMAGE)*</label>
			...
			<?php } ?>
			<div class="clearfix"></div>
			<?php if($cStepRes['video_link']){ ?>
			<div class="show-video-link">
				<div class="form-group col-sm-6">
					<label for="content_title" class="control-label">Video Title</label>
					<input type="text" name="content_title" value="<?=$cStepRes['content_title']?>" class="form-control" id="content_title<?=$cStepRes['id']?>" placeholder="Video Title" data-fv-regexp="true" data-error="Please enter video title" required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group col-sm-6">
