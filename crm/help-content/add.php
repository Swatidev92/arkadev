...
//print_r($_FILES);die;
	...
	if($_POST["material_type"]==2){
		$_POST['content_title']=$_POST['content_title'][0];
	}elseif($_POST["material_type"]==3){
		$_POST['content_title']=$_POST['content_title'][1];
	}if($_POST["material_type"]==1){
		$_POST['content_title']=$_POST['content_title'][2];
	}
	if($pid){         
    ...
    <div class="col-sm-12">
        <div class="white-box">
			<div class="form-group col-sm-6">
				<label for="help_name" class="control-label">Help Category</label>
			...
			<div class="text-center">
				<h4 class="control-label"><strong>Help content</strong></h4>
			</div>
			<hr>
			...
			<div class="show-file-upload" style="display:none;">
				<div class="form-group col-sm-6">
					...
					<input type="text" name="content_title[]" value="<?=$content_title?>" class="form-control" id="content_title" placeholder="File Title" data-fv-regexp="true" data-error="Please enter file title" required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group col-sm-6">
					<label for="content_title" class="control-label">Upload (DOC, EXCEL, PPT, PDF, IMAGE)*</label>
			...
			<div class="show-video-link" style="display:none;">
				<div class="form-group col-sm-6">
					...
					<input type="text" name="content_title[]" value="<?=$content_title?>" class="form-control" id="content_title" placeholder="Video Title" data-fv-regexp="true" data-error="Please enter video title" required>
					<div class="help-block with-errors"></div>
				</div>
				<div class="form-group col-sm-6">
