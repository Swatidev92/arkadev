...
//echo $_GET['start'];die;
	...
	$total_margin = 0;
		...
		//generate txt 
		$txtfilename = $id.'-'.($proposal_name?$proposal_name.'-':'').$customer_name.'-'.$file_name.'.txt';
 ...
 $pdf->SetTextColor(0, 0, 0);
	...
	//$pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.2, 'depth_h'=>0.2, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
		...
		*/
		...
		$final_file = $id.'-'.($proposal_name?$proposal_name.'-':'').$customer_name.'-'.$file_name.'.pdf';
...
$pdf->SetFont('dejavusans', '', 14, '', true);
 $pdf->SetTextColor(0, 0, 0);
	...
	//$pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.2, 'depth_h'=>0.2, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
		...
		$final_file3 = $id.'-'.($proposal_name?$proposal_name.'-':'').$customer_name.'-'.$file_name.'-area-chart.pdf';
 ...
 $pdf->SetTextColor(0, 0, 0);
	...
	//$pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.2, 'depth_h'=>0.2, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
		...
		*/
		...
		$final_file2 = $id.'-'.($proposal_name?$proposal_name.'-':'').$customer_name.'-'.$file_name.'-proposal2.pdf';
