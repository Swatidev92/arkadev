				...
				<table class="table table-striped1 table-hover table-bordered1">
					...
					<tbody>
						...
						<tr class="clickable-row">
							...
							<td class="table-center text-nowrap"><?=$leadsStatusArr[$status]?>/<?=date('Y-m-d',strtotime($cms->getSingleResult("SELECT action_date FROM #_lead_tracker where lead_id=".$id." ")))?></td>
