...
$_SESSION['REFERER_page']='';
	...
	if($action=='del'){
		//echo "update #_leads set is_deleted=1 where id in ($propId)";die;
	...
	$sql = " FROM #_leads l WHERE 1=1 AND l.is_deleted=0 AND l.lead_id=$pid $lead_status $adminRole ";
					...
					<tbody>
						...
						<tr class="clickable-row">
							...
							<td class="text-nowrap">
								...
								<?php echo '<a href="'.SITE_PATH_ADM.CPAGE.'?mode=proposal-list&id='.$pid.'&propId='.$propid.'&action=del" onclick="return confirm("Do you want delete this record?");" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-close text-danger"></i></a>';
								}else{?>
			...
			<div id="uplaod">
				...
				<div class="form-group col-sm-12">
					<div class="file_wrapper">
						...
						<div class="form-group col-sm-5">
							<label for="file_upload" class="control-label">Upload File (Size should be less than 2 MB)</label>
