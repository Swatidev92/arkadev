				...
				<div role="tabpanel" class="tab-pane <?php echo $active1;?>" id="proj_info">
					<div class="">
						...
						<div class="form-group col-sm-3" id="personnummer_error">
							...
							<input type="text" name="personnummer" value="<?=$custRes['personnummer']?>" class="form-control" id="personnummer" readonly>
						</div>
					...
					<div class="form-group col-sm-3">
						...
						<select class="form-control" name="grid_provider" id="grid_provider">
					...
					<div class="form-group col-sm-3">
						...
						<select class="form-control" name="grid_template" id="grid_template">
							<option value="">Select Grid provider</option>
					...
					<div class="form-group col-sm-2" style="margin-top:25px;">						
						<a class="fcbtn btn btn-warning btn-outline btn-1b" href="javascript:void()" onclick="generate()"> Generate</a>
					</div>
					<?php }if($grid_provider_template){?>
					<div class="form-group col-sm-1 text-center" style="margin-top:25px;">						
						<a href="<?=SITE_PATH.'uploaded_files/grid-provider/'.$grid_provider_template?>" class="btn btn-success btn-circle" download><i class="fa fa-file-pdf-o"></i> </a>
					</div>
					<div class="form-group col-sm-2" style="margin-top:25px;">						
						<a class="fcbtn btn btn-primary btn-outline btn-1c" href="javascript:void()" onclick="generate()"> Re-generate</a>
					</div>
					<?php } ?>
					<?php } ?>
					<div class="clearfix"></div>
					...
					<div id="page-wrap">		
						<div id="tabs">						
							<ul style="display:none">
								<?php $projectStepQry = $cms->db_query("select step_num, step_title from #_step_detail where status=1 AND is_deleted=0 order by step_num ");
								$i=1;
							...
							<?php $projectStepsQry = $cms->db_query("select step_num, step_title from #_step_detail where status=1 AND is_deleted=0 order by step_num ");
							$j=1;
							...
							<div id="fragment-<?=$projectStepsArr['step_num']?>" class="ui-tabs-panel <?=$j!=1?'ui-tabs-hide':''?>">
								<h3 class="step-title">Step <?=$projectStepsArr['step_num']?></h3>
								<?php $fieldQry = $cms->db_query("select *, id as fid from #_project_steps where step_id=".$projectStepsArr['step_num']." AND is_deleted=0 ");
								...
								<?php }else if($fieldRes['field_type']=='radio-group'){?>
									<div class="form-group col-sm-2">
										<div class="radio-list">
											<?php $field_values_obj = json_decode($fieldRes['field_values']);
											$val=1;
