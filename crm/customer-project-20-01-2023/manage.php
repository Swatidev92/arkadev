...
<?php 
	...
	if(isset($_REQUEST['submt'])){
		...
		$columns = "select p.id, p.project_name, p.project_address, p.sale_rep_id, p.project_manager_id, p.project_report_name, p.project_date, p.status, l.customer_name, l.battery_name, l.charger_name, l.inverter_type, l.inverter_type2, l.inverter_type3, l.panel_model, l.panel_count, l.roofing_material, l.sensor_type_name, l.odrift_type_name, l.optimizer_type_name ";
		...
		$start = intval($start);
		$pagesize = intval($pagesize)==0?$pagesize=DEF_PAGE_SIZE:$pagesize;
		$columns = "select p.id, p.project_name, p.project_address, p.project_city, p.sale_rep_id, p.project_manager_id, p.project_report_name, p.project_date, p.status, l.customer_name, l.battery_name, l.charger_name, l.inverter_type, l.inverter_type2, l.inverter_type3, l.panel_model, l.panel_count, l.roofing_material, l.sensor_type_name, l.odrift_type_name, l.optimizer_type_name ";
					...
					<tbody>
						...
						<tr>	
							...
							<td class="text-nowrap">
								...
								&nbsp;
								<?php if($project_report_name && file_exists(SITE_FS_PATH.UP_FILES_REPORTS.'/'.$project_report_name)){?>
