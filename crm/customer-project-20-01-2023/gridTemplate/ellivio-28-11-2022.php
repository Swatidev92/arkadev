...
$pdf->Text(60,177,iconv('UTF-8', 'windows-1252', html_entity_decode($leadRes['customer_name'])));
...
$pdf->Text(140,196,iconv('UTF-8', 'windows-1252', html_entity_decode($leadRes['email'])));
...
$pdf->Text(105,253,iconv('UTF-8', 'windows-1252', html_entity_decode($leadRes['customer_name'])));
