...
$pdf->Text(65,120,$leadRes['customer_name']);
$pdf->Text(65,124,$projectRes['project_address']);
$pdf->Text(65,128,$leadRes['email']);
$pdf->Text(65,132,$projectRes['plant_id']);
$pdf->Text(138,120,$leadRes['phone']);
$pdf->Text(138,132,$projectRes['main_fuse']);
