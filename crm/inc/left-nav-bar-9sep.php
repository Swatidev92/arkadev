...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
		<ul class="nav" id="side-menu">
			...
			<li> 
				<a href="<?=SITE_PATH_ADM?>lead-manager"><i class="ti-support fa-fw"></i> LMS</a>
			</li>
			...
			<li> 
				<a href="<?=SITE_PATH_ADM?>references-manager"><i class="ti-support fa-fw"></i> References Manager</a>
			</li>
			<li> 
				<a href="<?=SITE_PATH_ADM?>cms-manager"><i class="ti-support fa-fw"></i> CMS Manager</a>
			</li>
			
			<!--<li> 
				<a href="<?=SITE_PATH_ADM?>project-manager"><i class="ti-support  fa-fw"></i> Project Manager</a>
			</li>-->
		
			<li>
				<a href="<?=SITE_PATH_ADM?>enquiry-manager"><i class="ti-help-alt fa-fw"></i>Enquiry Manager</a>
			</li>
			<li>
				<a href="<?=SITE_PATH_ADM?>get-connected"><i class="ti-help-alt fa-fw"></i>Get Connected</a>
			</li>
			<li>
				<a href="<?=SITE_PATH_ADM?>calculator"><i class="ti-help-alt fa-fw"></i>Calculator</a>
			</li>
			<li><a href="javascript:void(0)" class="waves-effect">
