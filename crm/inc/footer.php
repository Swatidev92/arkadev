	...
	<!-- Bootstrap Core JavaScript -->
		...
		<script src="<?=SITE_PATH_ADM?>js/dashboard2.js?<?=time()?>"></script>
...
// Clock pickers
	...
	jQuery('#pre_registration_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#planned_start_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#planned_end_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#finish_start_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#finish_end_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#electrical_planned_start_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#electrical_planned_end_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#electrical_finish_start_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
	...
	jQuery('#electrical_finish_end_date').datepicker({
		autoclose: true,
		todayHighlight: true,
		gotoCurrent:true, 
		setDate: new Date(), //format: 'MM/DD/YYYY'
