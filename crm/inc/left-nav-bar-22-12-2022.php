    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
		<ul class="nav" id="side-menu">
			...
			<li><a href="javascript:void(0)" class="waves-effect">
				<i class="ti-support fa-fw"></i> <span class="hide-menu">LMS <span class="fa arrow"></span></span></a>
				<ul class="nav nav-second-level">
					...
					<li><a href="<?=SITE_PATH_ADM?>help" class="waves-effect"><i class="fa fa-group" aria-hidden="true"></i> <span class="hide-menu">Help</span></a></li>
					<li><a href="<?=SITE_PATH_ADM?>help-category" class="waves-effect"><i class="fa fa-group" aria-hidden="true"></i> <span class="hide-menu">Manage Help</span></a></li>
				</ul>
			</li>
			...
			<?php } } ?>
			<li><a href="javascript:void(0)" class="waves-effect">
				<i class="ti-support fa-fw"></i> <span class="hide-menu">Report <span class="fa arrow"></span></span></a>
				<ul class="nav nav-second-level">
			...
			<li>
				<a href="<?=SITE_PATH_ADM?>file-manager" class="waves-effect"><i class='fa fa-file'></i> <span class="hide-menu">File Manager<span class=""></span></span></a>
			</li>
		</ul>
	</div>
</div>
