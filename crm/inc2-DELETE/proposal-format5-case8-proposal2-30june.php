		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
							...
							<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background-color:#eee">
								<tbody>
									<tr>
										...
										<td width="20%" valign="middle" style="text-align:center;font-size:18px;border:none; color:#000;">
											10 dagar netto
										</td>
										<td width="55%" valign="middle" style="text-align:center;font-size:18px;border:none; color:#000;"></td>
									</tr>
								</tbody>
							</table>
						</td>
						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$cell0?>" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									...
									<tr>
										<td style="text-align:left;">100% faktureras vid funktionstestad anläggning</td>
						...
						<td>
							<table width="100%" align="center" cellspacing="<?=$cell1?>" cellpadding="1" border="0" class="devicewidth" modulebg="edit" style="background:#fff;">
								<tbody>
									...
									<?php if($battery_name){?>
									<tr>
										<td style="text-align:left; font-size:14px;">Batteri: <?=$battery_name?></td>
									...
									<tr>
										<td style="text-align:left; font-size:14px;">Växelriktare: <?=$inverter_brand?></td>
										<td style="text-align:center; font-size:14px;">1</td>
										<td style="text-align:center; font-size:14px;">st</td>
									</tr>
									<?php } ?>
									<tr>
										<td style="text-align:left; font-size:14px;">Smart powersensor: <?=strtok($inverter_brand, '-' )?></td>
										<td style="text-align:center; font-size:14px;">1</td>
										<td style="text-align:center; font-size:14px;">st</td>
									</tr>
									
									<tr>
										<td style="text-align:left; font-size:14px;">Elkapsling och säkringar</td>
										<td style="text-align:center; font-size:14px;">Efter behov</td>
										<td style="text-align:center; font-size:14px;"></td>
									</tr>
									<tr>
										<td style="text-align:left; font-size:14px;">Kablar och kontaktdon</td>
										<td style="text-align:center; font-size:14px;">Efter behov</td>
										<td style="text-align:center; font-size:14px;"></td>
									</tr>
								</tbody>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="<?=$pricespacing?>" cellpadding="<?=$pricepadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									<tr>
										<td style="text-align:left; font-size:14px; margin: 0px 10px;">
											Pris batterisystem exklusive moms:
										</td>
									...
									<tr>
										...
										<td style="text-align:left; font-size:14px; <?=$bold?>">
											Pris batterisystem inklusive moms:
										</td>
										<td style="text-align:left; font-size:14px; <?=$bold?>">
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="<?=$pricespacing?>" cellpadding="<?=$pricepadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff; border-top: 1px solid #000;">
								<tbody>
									<tr>
										<td style="text-align:left; font-size:14px;">
											<b>Pris batterisystem med grönt avdrag**:</b>
										</td>
										<td style="text-align:left; font-size:14px;">
											<b><?=amount_format_proposal(round($battery_price_after_green_deduction+$battery_extra_green_rebate))?> kr</b>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="<?=$textspacing?>" cellpadding="<?=$textpadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									<tr>
										<td style="text-align:left; font-size:14px;">*Förutsätter internetuppkoppling till växelriktare i form av WiFi.</td>
									</tr>
									
									<?php if($battery_name!=''){
										if($proposal_customer_type==1){?>
									<tr>
										<td style="text-align:left; font-size:14px;">**Grönt avdrag är 50% av totalbelopp menomfattar enbart material & arbetskostnader. Schablon är satt av Skatteverket till 48,5%.För mer information om bidraget och dess villkor,läs mer på <a href="https://www.skatteverket.se/">www.skatteverket.se</a></td>
									</tr>
									<?php } } ?>
								</tbody>
							</table>
