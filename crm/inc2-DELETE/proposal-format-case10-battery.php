							...
							<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" modulebg="edit" style="background-color:#eee;">
								<tbody>
									<tr>
										...
										<?php if($proposal_type!=5 && $proposal_type!=6 && $proposal_type!=7 && $number_of_proposal==1){
											$tdwidth = 30;
										}else{
											$tdwidth= 80;
										}
										if(($proposal_type==10 || $proposal_type==11) && $number_of_proposal==2){
											$proposal_total_cost = $battery_price_after_green_deduction;
											$total_price_excluding_vat = $total_price_excluding_vat-$price_excluding_vat;
										}
										if($proposal_type==3 && $number_of_proposal==2){
											$proposal_total_cost = $battery_price_after_green_deduction+$charger_price_after_green_deduction;
											$total_price_excluding_vat = $total_price_excluding_vat-$price_excluding_vat;
										}
										?>
