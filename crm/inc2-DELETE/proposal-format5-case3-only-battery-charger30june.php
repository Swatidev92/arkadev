		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
					...
					<tr><td></td></tr>
					<?php if($proposal_type==3 && $number_of_proposal==2){ ?>
					<tr><td></td></tr>
					<?php } ?>
					<?php if($proposal_type==1){ ?>
					<tr><td></td></tr>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="<?=$pricespacing?>" cellpadding="<?=$cellpadding?>" border="0" class="devicewidth" modulebg="edit" style="background:#fff; border-top: 1px solid #000;">
								<tbody>
									<tr>
										<td style="text-align:left; font-size:12px;">
