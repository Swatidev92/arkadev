		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="4" class="devicewidth" modulebg="edit" style="background:#ffffff; border-bottom: 1px solid #000;">
								<tbody>
									<tr>
									...
									<tr>
										<td width="50%"style="color:#fff; text-align:center;">
										   <img src="<?=SITE_PATH.UPLOAD_FILES_PTH.'/'.UP_FILES_PROPOSAL.'/'.$installation_image?>" width="270">
										</td>
										<td width="50%" style="text-align:center;">
											<img src="<?=SITE_PATH.UPLOAD_FILES_PTH.'/'.UP_FILES_PROPOSAL.'/'.$chart_image?>" width="270">
										</td>
									</tr>
								</tbody>
							</table>
					...
					<tr style="border-bottom: 1px solid #000;">
						<?php if($panel_img AND file_exists(CRM_FILES_PATH.'proposal/solar-panel/'.$panel_img)){?>
						<td width="50%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" class="devicewidth" modulebg="edit" style="background:#ffffff; border-bottom: 1px solid #000;">
								<tbody>
									<tr>
					...
					<tr style="border-bottom: 1px solid #000;">
						...
						<td width="50%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff; border-bottom: 1px solid #000;">
								<tbody>
									<tr>
										<td valign="middle" style="text-align:center;font-size:16px;border:none; color:#22914f;">
											Växelriktare 2
						...
						<td width="50%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff">
								<tbody>
									...
									<tr>
										<td style="color:#fff; text-align:center;">
										   <img src="<?=SITE_PATH.UPLOAD_FILES_PTH.'/'.UP_FILES_PROPOSAL.'/charger/'.$charger_img?>" style="height:131px;">
										</td>
									</tr>
								</tbody>
							</table>
						...
						<td width="50%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff">
								<tbody>
									...
									<tr>
										<td style="color:#fff; text-align:center;">
										   <img src="<?=SITE_PATH.UPLOAD_FILES_PTH.'/'.UP_FILES_PROPOSAL.'/battery/'.$battery_img?>" style="height:131px;">
										</td>
									</tr>
								</tbody>
							</table>
