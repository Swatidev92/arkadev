		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="0" class="devicewidth" modulebg="edit" style="background:#ffffff; ">
								<tbody>
									<tr>
					...
					<!-- <tr style="border-bottom: 1px solid #000;">
						...
						<?php }
						/*if($inverter_type && $inverter_img1 AND file_exists(CRM_FILES_PATH.UP_FILES_PROPOSAL.'/inverter/'.$inverter_img1)){?>
						<!-- <td width="50%">
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#ffffff; border-bottom: 1px solid #000;">
								<tbody>
									<tr>
