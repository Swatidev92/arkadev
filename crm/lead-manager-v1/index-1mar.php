...
<?php if($mode =='add'){include("add.php");}else if($mode =='add-proposal'){include("add-proposal.php");}else if($mode =='view'){include("view.php");}else if($mode =='view-lead'){include("view-lead.php");}else if($mode =='import') { include("import.php"); }else{include("manage.php");}?>
<script>
