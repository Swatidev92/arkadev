...
//echo $_GET['start'];die;
	...
	$total_margin = 0;
		...
		//generate txt 
		$txtfilename = $customer_name.'-'.$file_name.'.txt';
		...
		if($proposal_customer_type==1){
			if($proposal_type==8 || $proposal_type==9 || $proposal_type==10){
