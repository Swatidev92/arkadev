...
if($_FILES["installation_image"]["name"]){ 
	...
	$price_reduction=0;
	$total_discount=0;
	if(($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==4) && ($_POST['number_of_proposal']==1)){
...
$.ajax({
	...
	success: function(data){
		//alert();
		location.href="<?=SITE_PATH?>arka-admin/lead-manager-demo/generate-pdf.php?pid=<?=$lead_insert_id?>&start=<?=$pageTo?>";
	},
