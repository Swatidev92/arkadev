...
$obj_bdis = json_decode($priceRes['battery_discount']);
    ...
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<div class="form-group col-md-6">
				...
				<select class="form-control select2" id="proposal_type" name="proposal_type">
			...
			<div class="form-group col-md-3 show_battery_disc" style="<?=$stylebd?>">
				<label class="control-label">Battery discount (kr)</label>
			...
			<div class="form-group col-md-3 show_charger_disc" style="<?=$stylecd?>">
				<label class="control-label">Charger discount (kr)</label>
			...
			<div class="form-group col-md-6">
				<div>
					<input type="file" name="installation_image" id="input-file-max-fs" class="dropify" data-max-file-size="1M" data-height="150" <?php if($installation_image AND file_exists(FILES_PATH.'proposal/'.$installation_image)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/<?=$installation_image?>" <?php } ?> />
				</div>
			</div>
			<div class="clearfix"></div>
