    ...
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<div class="form-group col-md-4">	
				...
				<input type="date" class="form-control" name="post_date" placeholder="Lead date" value="<?=$post_date?>" disabled>
			</div>
			<div class="form-group col-md-3">
				<label class="control-label">Work Start</label>
				<select class="form-control" id="work_start" name="work_start" disabled>
			...
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="panel_area" value="<?=$panel_area?>" disabled>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" name="customer_name" placeholder="Full name" pattern="([^\s][A-Za-z\W+]+)" value="<?=$customer_name?>" disabled>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" name="phone" placeholder="Phone Number" pattern="[+0-9]{8,13}" value="<?=$phone?>" disabled>
			</div>
			<div class="clearfix"></div>
			<div class="form-group col-md-12">
				<label class="control-label">Address</label>
				<input type="text" class="form-control" name="proposal_address" placeholder="Address" value="<?=$proposal_address?$proposal_address:$address_input?>" disabled>
			</div>
			<div class="clearfix"></div>
			<div class="form-section-heading">	
			...
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="reference" placeholder="Our reference" pattern="([^\s][A-Za-z\W+]+)" value="<?=$reference?>" disabled>
			</div>
			<div class="form-group col-md-4">
				<label class="control-label">Reference Email</label>
				<input type="email" class="form-control" name="ref_email" placeholder="Reference Email" value="<?=$ref_email?>" disabled>
			</div>
			<div class="form-group col-md-4">
				<label class="control-label">Reference Phone</label>
				<input type="text" class="form-control" name="ref_phone" placeholder="Reference Phone" pattern="[+0-9]{8,13}" value="<?=$ref_phone?>" disabled>
			</div>
			<div class="clearfix"></div>
			<div class="form-group col-md-4">
				<label class="control-label">Quotation number</label>
				<input type="text" class="form-control" name="quotation_number" placeholder="Quotation number" value="<?=$quotation_number?>" disabled>
			</div>
			
			<div class="form-group col-md-4">	
				<label class="control-label">Quotation date</label>
				<input type="date" class="form-control" name="quotation_date" placeholder="Quotation date" value="<?=$quotation_date?>" disabled>
			</div>
			<div class="form-group col-md-4">
				<label class="control-label">Quotation valid till</label>
				<input type="date" class="form-control" name="quotation_valid_till" placeholder="Quotation valid for" value="<?=$quotation_valid_till?>" disabled>
			</div>
			<div class="clearfix"></div>
			<div class="form-section-heading">	
			...
			<div class="form-group col-md-3">
				...
				<select class="form-control" id="panel_model" name="panel_model" disabled>
			...
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="roofing_material" placeholder="Roofing material" value="<?=$roofing_material?>" disabled>
			</div>
			<div class="form-group col-md-4">
			...
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="panel_count" value="<?=$panel_count?>" disabled>
			</div>
			<div class="form-group col-md-3">
				<label class="control-label">Color</label>
				<input type="text" class="form-control" name="color" placeholder="Color" value="<?=$color?>" disabled>
			</div>
			<div class="form-group col-md-3">
			...
			<div class="clearfix"></div>
			<?php if($proposal_type==3 || $proposal_type==4 || $proposal_type==6 || $proposal_type==7 || $proposal_type==8 || $proposal_type==10){
				$styleb = '';
			}else{	
				$styleb = 'display:none';
			}
			...
			<div class="form-group col-md-3 show_battery_disc" style="<?=$stylebd?>">
				...
				<input type="text" class="form-control" name="battery_discount" id="battery_discount" placeholder="Battery discount" value="<?=$battery_discount?>" disabled>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" name="panels_angles" value="<?=$panels_angles?>" placeholder="Angle of panels" disabled>
			</div>
			<div class="clearfix"></div>
			<!--<div class="form-group col-md-6">
			...
			<div class="form-group col-md-6">
				<div>
					<input type="file" name="installation_image" id="drop_area<?=$id?>" class="dropify dropify-area-img" data-max-file-size="1M" data-height="150" <?php if($installation_image AND file_exists(FILES_PATH.'proposal/'.$installation_image)){ ?> data-default-file="<?=SITE_PATH?>uploaded_files/proposal/<?=$installation_image?>" <?php } ?> disabled />
				</div>
			</div>
			<div class="clearfix"></div>
			...
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="proposal_mms_cost" placeholder="MMS Cost" value="<?=$proposal_mms_cost?>" disabled>
			</div>
			<div class="clearfix"></div>
			...
			<div class="form-group col-md-3 show-solar-margin" style="<?=$stylesm?>">
				...
				<input type="text" class="form-control" name="solar_margin" value="<?=$solar_margin?$solar_margin:$obj_smrg[0]->margin?>" disabled>
			...
			<div class="form-group col-md-3 show-charger-margin" style="<?=$stylem?>">
				...
				<input type="text" class="form-control" name="charger_margin" value="<?=$charger_margin?$charger_margin:$obj_evmrg[0]->margin?>" disabled>
			...
			<div class="form-group col-md-3 show-battery-margin" style="<?=$stylebm?>">
				...
				<input type="text" class="form-control" name="battery_margin" value="<?=$battery_margin?$battery_margin:$obj_btmrg[0]->margin?>" disabled>
...
$("#proposal_type").change(function(){
	var p_type = $(this).val();
	//alert(f_status);
	if(p_type=="1" || p_type=="2" || p_type=="3" || p_type=="4" || p_type=="8" || p_type=="9" || p_type=="10"){
...
$("#proposal_type").change(function(){
	var p_type = $(this).val();
	//alert(f_status);
	if(p_type=="2" || p_type=="3" || p_type=="5" || p_type=="7" || p_type=="8" || p_type=="9"){
		$(".charger_show").show();
...
$("#proposal_type").change(function(){
	var p_type = $(this).val();
	//alert(f_status);
	if(p_type=="3" || p_type=="4" || p_type=="6" || p_type=="7" || p_type=="8" || p_type=="10"){
		$(".battery_show").show();
