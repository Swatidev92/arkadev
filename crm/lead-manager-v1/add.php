    ...
    <div class="col-sm-12">
        ...
        <div class="white-box">
			...
			<div class="form-group col-sm-4">
				...
				<div class="ui-widget">
					<input id="phone" type="text" name="phone" value="<?=$phone?>" class="form-control" placeholder="Phone" data-error="Phone Number is invalid" data-fv-regexp="true" <?=$disabled?>>
				</div>
				<div class="help-block with-errors"></div>	
			</div>
			<div class="clearfix"></div>
			...
			<!--<div class="form-group col-sm-4">
				...
				<input type="text" name="ort" value="<?=$ort?>" class="form-control" id="ort">
				<div class="help-block with-errors"></div>	
			</div>-->
			<?php } ?>
			<div class="form-group col-sm-4">
				<label for="address_input" class="control-label">Address</label>
				<input type="text" name="address_input" value="<?=$address_input?$address_input:$proposal_address?>" class="form-control" id="address_input" placeholder="Address">
				<div class="help-block with-errors"></div>	
			</div>
			...
			<div class="form-group col-sm-4">
				...
				<input type="text" name="postal_code" value="<?=$postal_code?>" class="form-control" id="postal_code" placeholder="Postal Code">
				<div class="help-block with-errors"></div>	
			</div>
			<?php } ?>
			<?php if($form_type==2){?>
			...
			<div class="form-group col-sm-4">
				...
				<input type="text" name="link_source" value="<?=$link_source?>" class="form-control">
			</div>
			<?php }*/ ?>
			<?php if($form_type!=1){?>
			<div class="form-group col-sm-4">
				<label for="purpose" class="control-label">Purpose</label>
				<input type="text" name="purpose" value="<?=$purpose?>" class="form-control">
			</div>
			<div class="clearfix"></div>
			<div class="form-group col-sm-6">
				<label for="message" class="control-label">Message</label>
				<textarea name="message" class="form-control" cols="30" rows="5"><?=$message?></textarea>
				<div class="help-block with-errors"></div>
			</div>
			<?php } ?>
			<div class="clearfix"></div>
			...
			<div class="form-group col-sm-6">
				...
				<select class="form-control" name="assigned_to"  data-error="Please select assigned to">
			...
			<div class="form-group col-sm-6">
				...
				<div class="form-group col-sm-12">
					...
					<select class="form-control leadStatuss" name="status">
