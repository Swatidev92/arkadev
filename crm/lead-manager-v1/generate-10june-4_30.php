...
if($_FILES["installation_image"]["name"]){ 
	...
	else if($_POST['proposal_type']==8 || $_POST['proposal_type']==9 || $_POST['proposal_type']==11){
		$_POST['total_green_rebate_kr'] = $_POST['green_rebate_kr']+$_POST['charger_green_rebate_kr']+$_POST['load_balancer_green_rebate_kr']+$_POST['battery_green_rebate_kr'];
	...
	if($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==4 || $_POST['proposal_type']==5 || $_POST['proposal_type']==6 || $_POST['proposal_type']==7 || $_POST['proposal_type']==8 || $_POST['proposal_type']==9 || $_POST['proposal_type']==10){
