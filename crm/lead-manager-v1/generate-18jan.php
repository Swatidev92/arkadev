...
if($_FILES["installation_image"]["name"]){ 
		...
		foreach ($batteryTyeArray as $bkey => $bvalue) {
			if($bvalue["name"] == $_POST['battery_name']){
				...
				if($_POST['battery_discount']!=''){
					...
					$_POST['battery_discount'] = $cvalue["bdiscount"];
				}
	...
	if(($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==4)){
	...
	if($_POST['charger_name']!=''){
		...
		if(($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==5 || $_POST['proposal_type']==7) && $_POST['load_balancer']==1){
