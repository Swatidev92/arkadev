    ...
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" name="proposal_address" placeholder="Address" value="<?=$proposal_address?$proposal_address:$address_input?>" required>
			</div>
			<div class="form-group col-md-6">
			...
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="ref_phone" placeholder="Reference Phone" value="<?=$ref_phone?>">
			</div>
			<div class="clearfix"></div>
			<div class="form-group col-md-4">
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="<?=SITE_PATH?>assets/images/installation-chart.jpg" class="img-responsive">
			</div>
		</div>
	</div>
</div>
