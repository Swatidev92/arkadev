...
//$_SESSION['REFERER_page']='';
	...
	// $arrRoof =$roofFetchDetailsQry->fetch_array();
					...
					<tbody>
						...
						<tr class="clickable-row" style="<?=$row_bg?>">
							...
							<td class="text-nowrap">
								...
								<br>
								<!-- mk-19 -->
								<?php if($a==1 || $b==1 || $c==1 || $d==1) {?>
									<a href="#" title="Generate Proposal" onclick="alert('Complete Roof Details')"><i class="fa fa-download" aria-hidden="true"></i></a>
								<?php }else{ ?>
								<a href="<?=SITE_PATH_ADM.CPAGE?>/generate-pdf2.php?pid=<?=$propid?>" title="Generate Proposal"><i class="fa fa-download" aria-hidden="true"></i></a><?php } ?>&nbsp;&nbsp;
