...
//$_SESSION['REFERER_page']='';
	...
	*/
	...
	if(!empty($_GET)){
		...
		$sql = " FROM #_leads l WHERE 1=1 AND l.is_deleted=0 AND l.lead_id=0 AND l.post_date>'2021-09-07' ".$conditionsQr." $adminRole ";
		...
		$pagesize = intval($pagesize)==0?$pagesize=DEF_PAGE_SIZE:$pagesize;
		$columns = "SELECT l.id, l.status, l.post_date, l.customer_name, l.proposal_address, l.assigned_to, l.form_type, l.post_by ";
		$sql = " FROM #_leads l WHERE 1=1 AND l.is_deleted=0 AND l.lead_id=0 AND l.post_date>'2021-09-07' $adminRole ";
		$order_by == '' ? $order_by = 'l.id' : true;
		$order_by2 == '' ? $order_by2 = 'DESC' : true;
