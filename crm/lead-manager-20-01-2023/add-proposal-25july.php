					...
					<thead class="show-table-header" style="<?=$sevbMaxstyle?>">						
						...
						<tr class="show-person-selection" style="<?=$showPerson?>">
							...
							<div class="form-check">
								...
								<th class="text-center form-group" colspan="2"><input class="form-check-input" type="radio" name="number_of_person" id="number_of_person2" value="2" <?=$number_of_person==2?'checked':''?> required>
						...
						<tr class="show-max-sevb" style="<?=$sevbMaxstyle?>">
							...
							<th class="text-center">Solar+Ev Charger</th>
							<th class="text-center">Battery</th>
						</tr>
					...
					<tbody>
						...
						<tr class="show-person-selection" style="<?=$showPerson?>">
							...
							<td class="show_charger_max_rebate form-group" style="<?=$stylec?>">
								<input type="number" class="form-control" name="person1_charger_max_rebate" value="<?=$person1_charger_max_rebate?>" min="0" max="20000">
							</td>
							...
							<td class="show-max-sevb form-group" style="<?=$sevbMaxstyle?>">
								...
								<input type="text" class="form-control" name="max_sevb_solarev_person2_rebate" value="<?=$max_sevb_solarev_person2_rebate?>">
							</td>
							<td class="show-max-sevb form-group" style="<?=$sevbMaxstyle?>">								
								...
								<input type="text" class="form-control" name="max_sevb_battery_person2_rebate" value="<?=$max_sevb_battery_person2_rebate?>">
							</td>
							...
							<td class="show-max-sev form-group" style="<?=$sevMaxstyle?>">
								...
								<input type="text" class="form-control" name="max_sev_solar_person2_rebate" value="<?=$max_sev_solar_person2_rebate?>">
							</td>
							<td class="show-max-sev form-group" style="<?=$sevMaxstyle?>">								
								...
								<input type="text" class="form-control" name="max_sev_charger_person2_rebate" value="<?=$max_sev_charger_person2_rebate?>">
							</td>
