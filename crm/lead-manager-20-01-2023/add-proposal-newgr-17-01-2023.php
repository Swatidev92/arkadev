		...
		<div class="white-box">
			<?php
				...
				<div role="tabpannel" class="tab-pane <?php echo $active1;?>" id="proj_info">
					...
					<?php $proposalType = json_decode($customerPriceArr["proposal_type_name_2"], true);
							//echo '<pre>';
					...
					<?php if($proposalCustomerType==1111){ ?>
					<div class="col-sm-12">
						<label class="control-label">Green Rebate</label>
...
$("#aforms").on("submit",function(e){
	if($("#save-generate").hasClass("disabled")==false){
		...
		$.ajax({
			url:"<?=SITE_PATH_ADM.CPAGE?>/generate-newgr.php",
...
$("#proposal_type").change(function(){
	...
	else if(p_type=="2" || p_type=="9" || p_type=="15"){
		$(".show-solar-margin").show();
		$(".charger_show").show();
	...
	else if(p_type=="3" || p_type=="8" || p_type=="14"){
		$(".show-solar-margin").show();
		$(".charger_show").show();
		$(".show-charger-margin").show();
		$(".battery_show").show();
	...
	else if(p_type=="4" || p_type=="10" || p_type=="11" || p_type=="16"){
		$(".show-solar-margin").show();
		$(".battery_show").show();
		//$("#show_sensor").hide();
		$("#sensor_type_name").prop('required',true);
