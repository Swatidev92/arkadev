...
//	echo $_POST['installation_cost'];die;
	...
	if($_POST['proposal_type']==1 || $_POST['proposal_type']==12){
		$_POST['battery_name']='';
		$_POST['charger_name']='';
	}
	if($_POST['proposal_type']==2 || $_POST['proposal_type']==5 || $_POST['proposal_type']==9 || $_POST['proposal_type']==13 || $_POST['proposal_type']==15){
		$_POST['battery_name']='';
	}
	if($_POST['proposal_type']==4 || $_POST['proposal_type']==6 || $_POST['proposal_type']==10 || $_POST['proposal_type']==11 || $_POST['proposal_type']==16){
		$_POST['charger_name']='';
	}
	
	// add condition if proposal_type have battery then must select sensor
	if(($_POST['proposal_type']=='8' || $_POST['proposal_type']=='11' || $_POST['proposal_type']=='14' || $_POST['proposal_type']=='16') && ($_POST['sensor_type_name']==''))
	{		
	...
	if($proposal_type!=5 && $proposal_type!=6 && $proposal_type!=7 && $proposal_type!=13){
	...
	if(($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==4 || $_POST['proposal_type']==8 || $_POST['proposal_type']==9 || $_POST['proposal_type']==10 || $_POST['proposal_type']==11 || $_POST['proposal_type']==14 || $_POST['proposal_type']==15 || $_POST['proposal_type']==16)){
	...
	echo 'green_rebate_kr';
	echo $_POST['green_rebate_kr'];
	
	if($_POST['charger_name']!=''){
		if(($_POST['proposal_type']==2 || $_POST['proposal_type']==3 || $_POST['proposal_type']==5 || $_POST['proposal_type']==7 || $_POST['proposal_type']==8 || $_POST['proposal_type']==9 || $_POST['proposal_type']==13 || $_POST['proposal_type']==15) && $_POST['load_balancer']==1){
	...
	// owner+co-owner green rebate
	echo 'per';
	echo $person1_person2_max_rebate = $_POST['person1_max_rebate']+$_POST['person2_max_rebate'];
	echo '---tot_gr_rebateis-'.$tot_gr_rebate;
	if($tot_gr_rebate > $person1_person2_max_rebate){
			...
			{	
					...
					if($dist_gr<$_POST['green_rebate_kr'])
						{
						echo 'solar--';echo '<br>';
						$_POST['total_green_rebate_kr'] = $dist_gr;
						$_POST['green_rebate_kr']=$_POST['total_green_rebate_kr'];
						
					}else{
						$_POST['total_green_rebate_kr'] = $_POST['green_rebate_kr'];
					}
			}
			...
			if($_POST['proposal_type']==9)
			{	
					echo 'solar+EV--';echo '<br>';
					
					echo $s_ev_gr = $_POST['green_rebate_kr']+$_POST['charger_green_rebate_kr'];
					$_POST['total_green_rebate_kr'] = $dist_gr;
					
					if($dist_gr<$s_ev_gr)
						{
						//Distribution into Solar and EV
						if($dist_gr<$_POST['charger_green_rebate_kr'])
						{
							$_POST['charger_green_rebate_kr'] = $_POST['total_green_rebate_kr'];
							$_POST['green_rebate_kr']=0;
						}
						else if($dist_gr>$_POST['charger_green_rebate_kr'])
						{
							$_POST['charger_green_rebate_kr'] = $_POST['charger_green_rebate_kr'];
							$_POST['green_rebate_kr']=$_POST['total_green_rebate_kr']-$_POST['charger_green_rebate_kr'];
						}
						
					}
					elseif($dist_gr>$s_ev_gr)
					{
						$s_ev_gr = $_POST['green_rebate_kr']+$_POST['charger_green_rebate_kr'];
						$_POST['total_green_rebate_kr'] = $s_ev_gr;
					
						//Distribution into Solar and EV
						$_POST['charger_green_rebate_kr'] = $_POST['charger_green_rebate_kr'];
						$_POST['green_rebate_kr'] = $_POST['green_rebate_kr'];
			...
			{	
					...
					$s_btr_gr = $_POST['green_rebate_kr']+$_POST['battery_green_rebate_kr'];
					...
					if($dist_gr<$s_btr_gr)
						...
						if($dist_gr<$_POST['battery_green_rebate_kr'])
						{
							$_POST['battery_green_rebate_kr'] = $dist_gr;
							$_POST['green_rebate_kr']=0;
						}
						else if($dist_gr>$_POST['battery_green_rebate_kr'])
						{
							$_POST['battery_green_rebate_kr'] = $_POST['battery_green_rebate_kr'];
							$_POST['green_rebate_kr']=$_POST['total_green_rebate_kr']-$_POST['battery_green_rebate_kr'];
						}
						
					}
					elseif($dist_gr>$s_btr_gr)
					{
			...
			{	
					...
					if($dist_gr<$s_btr_ev_gr)
						...
						else if($_POST['charger_green_rebate_kr']<$dist_gr)
						{
							$_POST['charger_green_rebate_kr']=$_POST['charger_green_rebate_kr'];
							$Remaining_1=$_POST['total_green_rebate_kr']-$_POST['charger_green_rebate_kr'];
							
						if($Remaining_1 > $_POST['battery_green_rebate_kr'])
							{
								$_POST['battery_green_rebate_kr']=$_POST['battery_green_rebate_kr'];
								$_POST['green_rebate_kr']=$Remaining_1-$_POST['battery_green_rebate_kr'];
							}
						elseif($Remaining_1 <= $_POST['battery_green_rebate_kr'])
							{
								$_POST['battery_green_rebate_kr']=$Remaining_1;
								$_POST['green_rebate_kr']=0;
							}
						}
						
					}
					elseif($dist_gr>$s_btr_ev_gr)
					{
						//Distribution into Solar and battery
						$_POST['charger_green_rebate_kr']=$_POST['charger_green_rebate_kr'];
						$_POST['battery_green_rebate_kr'] = $_POST['battery_green_rebate_kr'];
