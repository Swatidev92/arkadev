...
//	echo $_POST['installation_cost'];die;
	...
	if($_POST['proposal_type']!=8 && $_POST['proposal_type']!=9 && $_POST['proposal_type']!=10 && $_POST['proposal_type']!=11){
		...
		if($_POST['battery_green_rebate_kr']>$_POST['max_only_battery_rebate']){
			...
			$_POST['price_after_green_deduction'] = $_POST['price_after_green_deduction']+$battery_extra_cost;
		}else{
			$_POST['battery_extra_green_rebate'] = 0;
		}
		...
		//if perosn 1 then check GR on total of solar + battery
		if($_POST['number_of_person']==1){
			$_POST['total_green_rebate_kr'] = $_POST['green_rebate_kr']+$_POST['battery_green_rebate_kr'];
			if($_POST['total_green_rebate_kr']>$_POST['max_solar_battery_person1_rebate'] && $_POST['green_rebate_kr']<=$_POST['max_solar_battery_person1_rebate'] && $_POST['battery_green_rebate_kr']<=$_POST['max_solar_battery_person1_rebate']){
				$extra_cost = $_POST['total_green_rebate_kr']-$_POST['max_solar_battery_person1_rebate'];
				$_POST['battery_green_rebate_kr'] = $_POST['battery_green_rebate_kr']-$extra_cost;
				$_POST['extra_green_rebate'] = $extra_cost;
				$_POST['price_after_green_deduction'] = $_POST['price_after_green_deduction']+$extra_cost;
			}
			else if($_POST['total_green_rebate_kr']>$_POST['max_solar_battery_person1_rebate'] && $_POST['green_rebate_kr']>$_POST['max_solar_battery_person1_rebate'] && $_POST['battery_green_rebate_kr']<=$_POST['max_solar_battery_person1_rebate']){
				$extra_cost = $_POST['total_green_rebate_kr']-$_POST['max_solar_battery_person1_rebate'];
				$_POST['price_after_green_deduction'] = $_POST['price_after_green_deduction']+$_POST['green_rebate_kr'];
				$_POST['green_rebate_kr'] = 0;
				$_POST['extra_green_rebate'] = $extra_cost;
			}
			else if($_POST['total_green_rebate_kr']>$_POST['max_solar_battery_person1_rebate'] && $_POST['green_rebate_kr']>$_POST['max_solar_battery_person1_rebate'] && $_POST['battery_green_rebate_kr']>$_POST['max_solar_battery_person1_rebate']){
				//$extra_cost = $_POST['total_green_rebate_kr']-$_POST['max_solar_battery_person1_rebate'];
				$extra_cost = $_POST['battery_green_rebate_kr']-$_POST['max_solar_battery_person1_rebate'];
				$_POST['price_after_green_deduction'] = $_POST['price_after_green_deduction']+$_POST['green_rebate_kr']+$extra_cost;
				$_POST['battery_green_rebate_kr'] = $_POST['max_solar_battery_person1_rebate'];
				$_POST['green_rebate_kr'] = 0;
				$_POST['extra_green_rebate'] = $extra_cost;
			}
			else{
