				...
				<table class="table table-striped1 table-hover1 table-bordered">
					...
					<thead class="show-table-header" style="<?=$sevbMaxstyle?>">						
						...
						<tr class="show-person-selection" style="<?=$showPerson?>">
							...
							<div class="form-check">
								<th id="persontype" colspan="<?=$colspan?>" class="text-center"><input class="form-check-input" type="radio" name="number_of_person" id="number_of_person1" value="1" <?=$number_of_person==1?'checked':''?> required>
								<label class="form-check-label" for="number_of_person1">1 Person</label></th>
								
								<th class="text-center" colspan="2"><input class="form-check-input" type="radio" name="number_of_person" id="number_of_person2" value="2" <?=$number_of_person==2?'checked':''?> required>
					...
					<tbody>
						...
						<tr class="show-person-selection" style="<?=$showPerson?>">
							...
							<td class="show-solar-margin form-group" style="<?=$styles?>">solar
							...
							<td class="charger_show form-group" style="<?=$stylec?>">charger
							...
							<td>								
								<?php if($max_sevb_battery_person2_rebate==''){
