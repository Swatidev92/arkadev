...
<div class="row">
    <div class="col-sm-12">
		<div class="white-box panel-body">
			...
			<?php if($assigned_to!=''){
			$agentQry = $cms->db_query("SELECT id, customer_name, email_id, contact_no FROM #_users where id=$assigned_to AND status=1 AND is_deleted=0 ");
			...
			<div class="col-md-4">	
				...
				<div class="input-group">
					<input class="form-control" id="quotation_date" type="text" name="quotation_date" autocomplete="off" value="<?=($leadid!='' && $pid!='')?($quotation_date?$quotation_date:date('Y-m-d')):date('Y-m-d')?>">
			...
			<div class="col-md-4">
				...
				<div class="input-group">
					<input class="form-control" id="quotation_valid_till" type="text" name="quotation_valid_till" autocomplete="off" value="<?=($leadid!='' && $pid!='')?($quotation_valid_till?$quotation_valid_till:date('Y-m-d',strtotime(date("Y-m-d", strtotime(date('Y-m-d'))) . " +15 day"))):date('Y-m-d',strtotime(date("Y-m-d", strtotime(date('Y-m-d'))) . " +15 day"))?>">
					<span class="input-group-addon"><i class="icon-calender"></i></span> 
				</div>
			</div>
			<div class="clearfix"></div>
			...
			<div class="form-group col-md-3">
				...
				<input type="text" class="form-control" name="annual_electricity_consumption" value="<?=($leadid!='' && $pid!='')?$annual_electricity_consumption:''?>" placeholder="Annual electricity consumption in property">
			</div>
			<div class="form-group col-md-3">
