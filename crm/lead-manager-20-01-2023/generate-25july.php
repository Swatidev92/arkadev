	...
	if($_POST['proposal_type']==1){
		...
		if($_POST['number_of_person']==1){
			...
			if($total_max_rebate<=$_POST['max_solar_ev_battery_person1_rebate']){ 
				...
				//max charger green rebate should not be greater than 20000
				if($_POST['person1_charger_max_rebate']<=20000){
					...
					echo "Charger max rebate should not be greater than 20000";
					exit();
				}
				...
				echo "Sum of max rebate should not be greater than ".$_POST['max_solar_ev_battery_person1_rebate'];
				exit();
			}
		}
		//if person 2
		...
		if($_POST['number_of_person']==1){
			...
			if($total_max_rebate<=$_POST['max_solar_ev_person1_rebate']){ 
				...
				echo "Sum of max rebate should not be greater than ".$_POST['max_solar_ev_person1_rebate'];
				exit();
			}
		}
		//if person 2
		...
		if($_POST['number_of_person']==1){
			...
			if($total_max_rebate<=$_POST['max_solar_battery_person1_rebate']){ 
				...
				echo "Sum of max rebate should not be greater than ".$_POST['max_solar_battery_person1_rebate'];
				exit();
			}
		}
		//if person 2
