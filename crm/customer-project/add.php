							...
							<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
								...
								<div class="panel-collapse collapse in" id="exampleCollapseDefaultOne" aria-labelledby="exampleHeadingDefaultOne" role="tabpanel">
									<div class="panel-body" style="max-height:432px;overflow:auto;">
										<p style="font-size:12px;"><b style="margin:20px;"> Generated by</b>
										<b style="font-size:12px;margin:20px;">Date</b><hr style="border-color: rgb(0 0 0 / 13%);margin-top: 10px;margin-bottom: 10px;">
										<?php $logQry=$cms->db_query("select *  from #_egenkontroll_logs where cust_id='$cust_id' order by created_at desc");
				...
				<div role="tabpanel" class="tab-pane <?php echo $active7;?>" id="inventory">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>-</td>
								<td><?=$otherDetailsArr['surge_protc_dc']?></td>
							</tr> 
							<?php } } ?>
