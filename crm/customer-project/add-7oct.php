					...
					if($_POST['pic_id'][$i] && !empty($_FILES["pic_upload"]["name"][$i])){
						if(!empty($_FILES["pic_upload"]["name"][$i])){
							...
							if($file_size>0 && $file_size>5000000){
								...
								//$uploadArr['proposal_id']=$lead_insert_id;
								$updateArr['lead_id']=$PROJECTARR['lead_id'];
			...
			<div class="tab-content" style="margin-top:0px;">
				...
				<div role="tabpanel" class="tab-pane <?php echo $active1;?>" id="proj_info">
					...
					<div class="form-group col-sm-3">
						...
						<input type="text" name="house_type" value="<?=$house_type?>" class="form-control purple-field" id="house_type" data-fv-regexp="true" data-error="Please enter valid Name">
						<div class="help-block with-errors"></div>
					</div>		
					<div class="clearfix"></div>
					<div class="form-group col-sm-3">
