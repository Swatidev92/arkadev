			...
			<div class="tab-content" style="margin-top:0px;">
				...
				<div role="tabpanel" class="tab-pane <?php echo $active1;?>" id="proj_info">
					...
					<div class="form-group col-sm-3">
						...
						<input type="text" name="kortslutningsström" value="<?=$kortslutningsström?>" class="form-control" id="kortslutningsström" readonly>
						<div class="help-block with-errors"></div>
					</div>
					<div class="form-group col-sm-3">
...
$(function() {
	...
	$(".ui-tabs-panel").each(function(i){
		...
		if (i != totalSize) {
			next = i + 2;
			$(this).append("<a href='#' class='next-tab mover' rel='" + next + "'>Next Steo &#187;</a>");
		}
		if (i != 0) {
			prev = i;
