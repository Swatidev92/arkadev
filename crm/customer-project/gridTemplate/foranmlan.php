...
$pdf->Text(65,120,iconv('UTF-8', 'windows-1252', html_entity_decode($customer_name)));
$pdf->Text(65,124,iconv('UTF-8', 'windows-1252', html_entity_decode($projectRes['project_address'])));
$pdf->Text(65,128,iconv('UTF-8', 'windows-1252', html_entity_decode($email)));
$pdf->Text(65,132,$projectRes['plant_id']);
$pdf->Text(138,120,$phone);
...
$pdf->Text(110,243,iconv('UTF-8', 'windows-1252', html_entity_decode($customer_name)));
$pdf->Text(118,254,$phone);
