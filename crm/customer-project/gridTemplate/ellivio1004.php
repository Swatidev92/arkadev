...
$pdf->Text(62,106,$projectRes['project_address']);

if($leadRes['proposal_customer_type']==2 && $projectRes['enskild_firma']==0){
	$pdf->Text(60,187,$projectRes['company_name']);
}
if($leadRes['proposal_customer_type']==2 && $projectRes['enskild_firma']==1){
	$pdf->Text(60,187,$projectRes['company_name']);
}

$pdf->Text(60,177,$leadRes['customer_name']);

if($leadRes['proposal_customer_type']==2 && $projectRes['enskild_firma']==0){
	$pdf->Text(140,177,$projectRes['org_number']);
}
if($leadRes['proposal_customer_type']==1){
	$pdf->Text(140,177,$leadRes['personnummer']);
}
if($leadRes['proposal_customer_type']==2 && $projectRes['enskild_firma']==1){
	$pdf->Text(140,177,$leadRes['personnummer']);
}

$pdf->Text(140,187,$leadRes['phone']);
$pdf->Text(60,196,$projectRes['project_address']);
$pdf->Text(140,196,$leadRes['email']);
$pdf->Text(40,206,$projectRes['project_postal_code']);
$pdf->Text(80,206,$projectRes['project_city']);
$pdf->Text(105,253,$leadRes['customer_name']);
$pdf->Text(40,241,date('Ymd'));
$pdf->Text(62,241,$projectRes['project_city']);
