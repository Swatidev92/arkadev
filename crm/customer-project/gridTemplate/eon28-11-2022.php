...
$pdf->Text(80,193,iconv('UTF-8', 'windows-1252', html_entity_decode($leadRes['customer_name'])));
...
$pdf->SetTextColor(0,0,0);
$pdf->Text(55,189,'0');
$pdf->Text(113,238,iconv('UTF-8', 'windows-1252', html_entity_decode($leadRes['customer_name'])));
$pdf->Text(113,251,$leadRes['phone']);
