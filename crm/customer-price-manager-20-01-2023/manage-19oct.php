							...
							<div class="panel">
								...
								<?php
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
                                            Price
                                            <input autocomplete="off" name="evc[<?=$i?>][price]" type="text" placeholder="Price" class="form-control" value="<?=$val->price?>"/>
                                        </div>
                                    </div> 
									<div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
							...
							<div class="panel">
								...
								<div class="col-xs-2 col-sm-2 col-md-2">
                                    ...
                                    <div class="col-xs-1 col-sm-1 col-md-1">
                                        <div class="form-group">
                                            Price
                                            <input autocomplete="off" name="pty[<?=$i?>][price]" type="text" placeholder="Price" class="form-control" value="<?=$val->price?>"/>
                                        </div>
                                    </div> 
									<div class="col-xs-2 col-sm-2 col-md-2">
                                        <div class="form-group">
							...
							<div class="panel">
								...
								<?php
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
                                            Price
                                            <input autocomplete="off" name="invt[<?=$i?>][price]" type="text" placeholder="Price" class="form-control" value="<?=$val->price?>"/>
                                        </div>
                                    </div> 
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
							...
							<div class="panel">
								...
								<?php
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
                                            Price
                                            <input autocomplete="off" name="btrcs[<?=$i?>][price]" type="text" placeholder="Price" class="form-control" value="<?=$val->price?>"/>
                                        </div>
                                    </div> 
									<div class="col-xs-3 col-sm-3 col-md-3">
                                        <div class="form-group">
							...
							<div class="panel">
								...
								<?php
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            Price
                                            <input autocomplete="off" name="intc[<?=$i?>][price]" type="text" placeholder="Price" class="form-control" value="<?=$val->price?>"/>
                                        </div>
                                    </div> 
...
$(document).ready(function()
	...
	$('.list_add_button4').click(function()
	    ...
	    if(x4 < list_maxField){ 
	        ...
	        var list_fieldHTML = '<div class="row"><div class="col-xs-4 col-sm-4 col-md-4"><div class="form-group"><input name="intc['+x4+'][day]" type="text" placeholder="Day" class="form-control"/></div></div><div class="col-xs-4 col-sm-4 col-md-4"><div class="form-group"><input name="intc['+x4+'][price]" type="text" placeholder="Price" class="form-control"/></div></div><div class="col-xs-1 col-sm-7 col-md-1"><a href="javascript:void(0);" class="list_remove_button btn btn-danger">-</a></div></div>'; //New input field html 
