...
class DAL {  
	...
	function user_login($username,$password){		
		$sql ="select `id`, `username`, `fname`, `lname`, `email`, `contact`,  `type`, `status` from ".tb_Prefix."administrator where username='$username' and password='$password' AND status=1 AND is_deleted=0 ";  
		//echo $sql;
