	...
	*/
	...
	{	
			...
			try {
				...
				$mail->addBCC("anil.dua@arkaenergy.se", "Anil Dua");			   
				$mail->Subject = $subject;
				$mail->Body    = $mailBody;
				$mail->IsHTML(true);
...
//echo $m1 = sendEmail('sneha.techblue@gmail.com', 'hi', 'Thankyou');die;
	...
	function generateReport($report_Arr){
		...
		$generate= $pdf->Output(SITE_FS_PATH.'/'.UPLOAD_FILES_PTH.'/'.UP_FILES_REPORTS.'/'.$report_filename.'.pdf', 'F');
	...
	$proposalStatus = array("1"=>"Project Created","8"=>"Föranmälan Ready","2"=>"Föranmälan Sent","3"=>"Föranmälan Approved","4"=>"Panel Installation Completed","5"=>"Electric Installation Completed","6"=>"Commissioned","7"=>"Handed over to customer","9"=>"Färdig anmälan sent");
	$vendorWorkType = array("1"=>"Panel Installation","2"=>"Electrician","3"=>"Both");
	
	$documentType = array("1"=>"Solar Report","2"=>"MMS Report Roof","3"=>"BOM MMS Roof","4"=>"Föranmälan");
	$pictureType = array("1"=>"String Diagram","2"=>"Panel Layout Roof","3"=>"All Equipment Placement","4"=>"Inverter Placement","5"=>"EV Placement","6"=>"Battery Placement","7"=>"Roof Picture","8"=>"Location for material delivery");
	$uploadFileType = array("1"=>"Document","2"=>"Picture");
	
	$gridProvider = array("1"=>"Ellevio","2"=>"EON","3"=>"Vattenfall","4"=>"Other");
	$gridTemplate = array("1"=>"Ellevio","2"=>"EON","3"=>"Föranmälan.nu");
	$electricityMeterArr = array("1"=>"Inside house in basement","2"=>"Inside house in El-central","3"=>"Outside house in Fasadskåp");
?>