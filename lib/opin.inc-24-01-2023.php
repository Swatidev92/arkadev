...
//echo $m1 = sendEmail('sneha.techblue@gmail.com', 'hi', 'Thankyou');die;
	...
	$pictureType = array("1"=>"String Diagram","2"=>"Panel Layout Roof","3"=>"All Equipment Placement","4"=>"Inverter Placement","5"=>"EV Placement","6"=>"Battery Placement","7"=>"Roof Picture");
