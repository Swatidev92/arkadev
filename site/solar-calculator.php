...
.condition{
	...
	<?php $calCQry = $cms->db_query("SELECT * FROM #_solar_calculator where id=1");
	$calCRes = $calCQry->fetch_array();
	
	$metaTitle= $calCRes['meta_title'.$langf];
	$metaIntro= $calCRes['meta_description'.$langf];
	$metaKeyword= $calCRes['meta_key'.$langf];
			...
			<div class="holder">
				<div class="calculator-tab">
					<ul class="nav nav-tabs nav-justified" role="tablist" id="form-tab">
						...
						<li role="presentation" class=" hidden-sm hidden-xs disabled summary-no-right-border">
						...
						<li class="annual-summary-top left-top-radius1 mobile-border-left">
										...
										<div class="col-md-12">
											...
											<div class="row">									
												<div class="col-md-9 col-sm-9 col-xs-9">
													...
													<input type="hidden" id="postcode" name="postcode" value="<?=$_POST['postcode']?$_POST['postcode']:''?>" />
													<input type="hidden" id="address2" name="address2" value="<?=$_POST['address2']?$_POST['address2']:''?>" />
												</div>
					...
					<div role="tabpanel" class="tab-pane" id="pannel">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none">
								<div class="calculator-leftbox1">
									<div class="wrapper_second_useful_2">
										<img class="essential-img" src="<?=SITE_PATH?>assets/images/calculator/panels/optimized.jpg" width="100%">
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<label class="have-rooftop-lable">
														...
														<div class="rooftop-radio-label"><?=$solarRes['sec2_title1'.$langf]?></div>
													</label>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<label class="have-rooftop-lable">
														<input type="radio" name="panel_type" value="Esthetic">
														<div class="rooftop-radio-label"><?=$solarRes['sec2_title2'.$langf]?></div>
													</label>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<label class="have-rooftop-lable">
														<input type="radio" name="panel_type" value="Performance">
														<div class="rooftop-radio-label"><?=$solarRes['sec2_title3'.$langf]?></div>
													</label>
												</div>
												<input type="hidden" name="sel_panel_type" id="sel_panel_type" value="Optimized">
												<input type="hidden" name="panel_val" id="panel_val" value="<?=$solarRes['panel_capacity1'.$langf]?>">
											</div>
											
											<div class="onPanelSel" id="onPanelSel1">
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
														<label class="panel-text" id="panel_type_name"><?=$solarRes['sec2_title1'.$langf]?></label>
													</div>
													<div class="col-lg-6 col-md-6 col-sm-4 col-xs-4 text-right">
														<label class="panel-text" id="panel_type_val"><?=$solarRes['panel_capacity1'.$langf]?>W</label>
													</div>
												</div>
												<div class="row">
													<div class="col-md-12">	
											...
											<div class="onPanelSel" id="onPanelSel2" style="display:none">
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
														<label class="panel-text" id="panel_type_name"><?=$solarRes['sec2_title2'.$langf]?></label>
													</div>
													<div class="col-lg-6 col-md-6 col-sm-4 col-xs-4 text-right">
														<label class="panel-text" id="panel_type_val"><?=$solarRes['panel_capacity2'.$langf]?>W</label>
													</div>
												</div>
												<div class="row">
													<div class="col-md-12">
											...
											<div class="onPanelSel" id="onPanelSel3" style="display:none">
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
														<label class="panel-text" id="panel_type_name"><?=$solarRes['sec2_title3'.$langf]?></label>
													</div>
													<div class="col-lg-6 col-md-6 col-sm-4 col-xs-4 text-right">
														<label class="panel-text" id="panel_type_val"><?=$solarRes['panel_capacity3'.$langf]?>W</label>
													</div>
												</div>
												<div class="row">
													<div class="col-md-12">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none">
								<div class="calculator-leftbox" style="background: url(<?=SITE_PATH?>assets/images/calculator/background-green.jpg)">
									<div class="wrapper_second_useful_2">
										...
										<div class="summary-table-outer">
											<table class="summary-table">
												<tr>
													<th><?=$countryConst=='SE'?'Total kostnad (efter grönt avdrag)':'Total cost (after green subsidy)'?></th>
									...
									<p class="condition"><?=$countryConst=='SE'?'Obs - Detta är ett uppskattat pris. Priset kan skilja sig på grund av material och installation kostnader.':'Note - This is an estimated price. The actual price can be different depending on the material and installation cost.'?></p>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="first_name" pattern="([^\s][A-zÀ-ž\s]+)" required>
												<label class="control-label"><?=$countryConst=='SE'?'Förnamn':'First name'?></label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="last_name" pattern="([^\s][A-zÀ-ž\s]+)" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="address_input" id="address_input" value="<?=$_POST['address2']?$_POST['address2']:''?>" required>
												<label class="control-label"><?=$countryConst=='SE'?'Adress':'Address'?></label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="postal_code" id="postal_code" value="<?=$_POST['postcode']?$_POST['postcode']:''?>" required>
...
<!-- Async script executes immediately and must be after any DOM elements used in callback. -->
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCpvkDGXhNs5yjoEkXtYERc5Nhy64NTXO0&callback=initAutocomplete&v=weekly&libraries=places,drawing" async> </script>
 ...
 $.ajax({
		...
		success:function(result){
			...
			if(res[0]!=''){	
				...
				if(res[1]>100){
					if('<?=$countryConst?>' == 'SE'){
						$('.more-panel').html('<p class="more-panel-error">Du had markerat ett område med fler än 100 solpaneler. Kontakta oss så återkommer vi inom kort.</p>');
						$('.contact-link-map').html('<a href="<?=SITE_PATH.$urlConst?><?=$countryConst=="SE"?"kontakta-oss":"contact-us"?>" class="map-contact-btn"><?=CONTACT?></a>');
					}else{
						$('.more-panel').html('<p class="more-panel-error">You have selected an area with more than 100 panels. Please contact us and we will return to you shortly.</p>');
						$('.contact-link-map').html('<a href="<?=SITE_PATH.$urlConst?><?=$countryConst=="SE"?"kontakta-oss":"contact-us"?>" class="map-contact-btn"><?=CONTACT?></a>');
					}
