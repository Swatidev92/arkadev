	...
	<?php $solarQry = $cms->db_query("SELECT * FROM #_solar ");
	...
	<div class="sw_blog_categories_2_wrapper pst grey-bg default-padding">
		<div class="container">
            <div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="sw_left_heading_wraper sw_center_heading_wrapper">
                        <h1><span class="heading-bold">Solpanel paket</span></h1>
                    </div>
                </div>
			</div>
			<div class="row">
									...
									<div class="tabs-content">
											...
											<div class="row">
													...
													<div class="solar-inner-box">
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-8">
																		<h3 class="solar-panel-name">Optimized</h3>
																	</div>
																	<div class="col-md-4">
																		<h3 class="solar-capacity">400W</h3>
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="solar-inner-box">
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-12">
																		<p class="panel-info"><b>Produktinformation</b></p>
																		...
																		<div class="disc_btn text-center">
																			<ul>
																				<li>
																					<a href="<?=SITE_PATH.$urlConst?>kostnadskalkyl" class="green-border-btn">Kostnadskalkyl</a>
																				</li>
																			</ul>
																		</div>
																	</div>
												...
												<div class="col-md-6 col-sm-4">
													<div class="text-center">
														<img src="<?=SITE_PATH?>assets/images/panel/optimize.png" class="img-responsive">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="tab" id="tab-2">
											<div class="row">
													...
													<div class="solar-inner-box">
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-8">
																		<h3 class="solar-panel-name">Esthetic</h3>
																	</div>
																	<div class="col-md-4">
																		<h3 class="solar-capacity">395W</h3>
																	</div>
																</div>
															</div>
														</div>
																...
																<div class="row">
																	<div class="col-md-12">
																		...
																		<div class="disc_btn text-center">
																			<ul>
																				<li>
																					<a href="<?=SITE_PATH.$urlConst?>kostnadskalkyl" class="waves-effect waves-light waves-ripple green-text green-border-btn">Kostnadskalkyl</a>
																				</li>
																			</ul>
																		</div>
																	</div>
												...
												<div class="col-md-6 col-sm-4">
													<div class="text-center">
														<img src="<?=SITE_PATH?>assets/images/panel/Design.png" class="img-responsive">
													</div>
												</div>
											</div>
										</div>
										<div class="tab" id="tab-3">
											<div class="row">
													...
													<div class="solar-inner-box">
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-8">
																		<h3 class="solar-panel-name">Performance</h3>
																	</div>
																	<div class="col-md-4">
																		<h3 class="solar-capacity">375W</h3>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-12">
																		<p class="panel-info"><b>Produktinformation</b></p>
																		<p>Performance panelerna ger en robusthet med hög effektivitet och är optimerade för en extra lång livslängd med höga prestandagarantier.</p>
																		<ul class="solar-panel-list-info">
																			<li>Öka prestandagarantin (mer än 90% effekt efter 25 år)</li>
																			<li>Minskad förlust vid skuggning</li>
																			<li>Högsta effekttäthet (watt/kvm)</li>
																		</ul>
												...
												<div class="col-md-6 col-sm-4">
													<div class="text-center">
														<img src="<?=SITE_PATH?>assets/images/panel/Pro.png" class="img-responsive">
													</div>
												</div>
											</div>
										</div>
	...
	<div class="sw_blog_categories_2_wrapper pst grey-bg default-padding">
		<div class="container">
            <div class="row">
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="sw_left_heading_wraper sw_center_heading_wrapper">
                        <h1><span class="heading-bold">Solar panel packages</span></h1>
                    </div>
                </div>
			</div>
			<div class="row">
													...
													<div class="solar-inner-box">
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-12">
																		<p class="panel-info"><b>Product information</b></p>
																		...
																		<div class="disc_btn text-center">
																			<ul>
																				<li>
																					<a href="<?=SITE_PATH?>solar-calculator" class="green-border-btn">Solar Calculator</a>
																				</li>
																			</ul>
																		</div>
																	</div>
														...
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-12">
																		<p class="panel-info"><b>Product information</b></p>
																		<p>Esthetic solar panels are our all-black panel that appeals to customers who demand stylish panels but without compromising on quality and effect.</p>
																		<ul class="solar-panel-list-info">
														...
														<div class="text">													
															<div class="ib-text">
																<div class="row">
																	<div class="col-md-12">
																		<p class="panel-info"><b>Product information</b></p>
																		<p>The Performance panels provide robustness with high efficiency and are optimized for an extra long warranty and performance guarantees.</p>
																		<ul class="solar-panel-list-info">
																			<li>Increase performance guarantee (more than 90% effect after 25 years)</li>
																			<li>Reduced loss when shading</li>
																			<li>Highest power density (watts/sqm)</li>
																		</ul>
