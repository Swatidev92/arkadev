 ...
 $.ajax({
		...
		success:function(result){
			...
			if(res[0]!=''){	
				...
				if(res[1]>50){
					$('.more-panel').html('<p class="more-panel-error">According to your area selection , number of solar panels required are '+res[1]+'</p>');
					$('.contact-link-map').html('<a href="" class="map-contact-btn">Contact us</a>');
