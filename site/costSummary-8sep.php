...
echo amount_format($price).'|'.amount_format($annual_savings).'|'.amount_format($greenSubsidy).'|'.$payback_time.'|'.value_format($yearlyProd).'|'.$panels.'|'.$panel_type.'|'.$slope_type.'|'.$battery.'|'.$charger.'|'.$roof_area.'|'.$total_capacity;
