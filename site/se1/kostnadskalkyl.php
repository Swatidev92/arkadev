...
<!-- Async script executes immediately and must be after any DOM elements used in callback. -->
 ...
 <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBcuL09_sSUWR-65TVL061A0xG4TKGAhrA&callback=initAutocomplete&v=weekly&libraries=places,drawing"
      async
    ></script>
			...
			<div class="holder">
				<div class="calculator-tab hidden-sm hidden-xs">
					<ul class="nav nav-tabs nav-justified" role="tablist" id="form-tab">
						<li role="presentation" class="active">
							<a href="#address" aria-controls="address" role="tab" data-toggle="tab" aria-expanded="true">Adress</a>
						</li>
						<li role="presentation" class="disabled">
							<a href="#mark-roof" aria-controls="mark-roof" role="tab" data-toggle="tab" aria-expanded="false">Markera tak</a>
						</li>
						<li role="presentation" class="disabled">
							<a href="#roof-slope" aria-controls="roof-slope" role="tab" data-toggle="tab" aria-expanded="false">Taklutning</a>
						</li>
						<li role="presentation" class="disabled">
							<a href="#pannel" aria-controls="pannel" role="tab" data-toggle="tab" aria-expanded="false">Paneltyp</a>
						</li>
						<li role="presentation" class="disabled summary-no-right-border">
							<a href="#summary" aria-controls="summary" role="tab" data-toggle="tab" aria-expanded="false">Sammanfattning</a>
						</li>
						<li class="annual-summary-top left-top-radius1">
							<div class="saving-inline annual-saving">
								...
								<div class="annual-text">
									...
									<p class="annual-saving-text">Årlig besparing</p>
								</div>
							</div>
						</li>
						<li class="annual-summary-top top-right-corner">
							<div class="saving-inline annual-cost">
								...
								<div class="annual-text">
									...
									<p class="annual-cost-text">Kostnad</p>
								</div>
							</div>
						</li>
					</ul>
				...
				<div class="tab-content">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
								<div class="calculator-form-box form-boc-top">
									<div class="row">									
										<div class="col-md-12">
											<label class="label-text">Ange din adress</label>
											<!--<p class="sub-label">Ange ett hem för dina nya solpaneler</p>-->
											<div class="row">									
												<div class="col-md-9">
													<input type="text" name="address" placeholder="Adress" id="sel_address">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none">
								<div class="calculator-leftbox">
									<div class="wrapper_second_useful_2">
										<div id="map"></div>
										<div class="css-6tshae resetmap" style="display:none;"><span class="carea"></span><span class="panelonmap"></span><a href="javascript:void(0);" onclick="reset();"><i class="fa fa-undo"></i> <span class="css-joun2m">Återställ</span></a></div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
								<div class="calculator-form-box form-boc-top">
									<div class="row">
										<div class="col-md-12">
											<label class="label-text">Mät ditt takområde</label>
											<p class="sub-label">Klicka på varje hörn av ditt tak för att mäta ditt takområde</p>		
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
								<div class="calculator-form-box form-boc-top">
									<div class="row">
										<div class="col-md-12">
											<label class="label-text">Välj taklutning</label>
											<!--<p class="sub-label">Hur lutande är ditt tak?</p>-->
											<div class="row">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
								<div class="calculator-form-box" style="margin-bottom:20px;">
									<div class="row">
										<div class="col-md-12">
											<label class="label-text">Vilken modell av solpaneler vill du använda</label>
											<p class="sub-label">Välj från de tre alternativen nedan. Pris och besparingar uppdateras automatiskt när du skiftar mellan de olika alernativen.</p>
											<div class="row">
					...
					<div role="tabpanel" class="tab-pane" id="summary">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none">
								<div class="calculator-leftbox" style="background: linear-gradient(90deg, #018d45 10%, #10c166 35%, #43dc8e 100%);">
									<div class="wrapper_second_useful_2">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-left-none">
								<div class="lettalk-form-box">
									<div class="row">
										<div class="col-md-12">
											<h1 class="let-talk">Fyll i dina uppgifter</h1>
											<p>Vänligen ange detaljerna i formuläret nedan så kontaktas ni av en av våra solcellsexperter.</p>
										</div>
										...
										<div class="col-md-6">
											<input type="text" name="address_input" id="address_input" placeholder="Adress*" required>
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-12">
											...
											<label class="form-check-label" for="exampleCheck1">Jag accepterar Arka Energys villkor och att min personliga information behandlas i enlighet med gällande lagar. Arka Energy har också tillstånd att hämta min konsumtionsdata från min energileverantör.</label>
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-9">
												<div class="calculator-get-started cntct_2_btn_inner text-right">
													...
													<button type="submit" class="submitForm1 nextbtn continue" id="calculatorSubmit" style="line-height:inherit">Skicka <i class="fa fa-long-arrow-right"></i> </button>
												</div>
											</div>
										</div>
									</div>
	...
	$.ajax({
		...
		success:function(result){
			...
			if(res[0]!=''){	
				...
				$('.panelonmap').html(res[1]+' Solpaneler');
				$('#size').val(res[0]);
				$('#panels').val(res[1]);
			}
		}
