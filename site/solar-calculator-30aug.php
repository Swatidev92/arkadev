			...
			<div class="holder">
				...
				<div class="tab-content">
								...
								<div class="calculator-form-box tab4-right-box">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
													<label class="label-text addon-text"><?=$countryConst=='SE'?'Tillägg':'Addon'?></label>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
													<label class="have-rooftop-lable">
					...
					<div role="tabpanel" class="tab-pane" id="summary">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 padding-right-none">
								<div class="calculator-leftbox" style="background: url(assets/images/calculator/background-green.jpg)">
									<div class="wrapper_second_useful_2">
										...
										<div class="summary-table-outer">
											<table class="summary-table">
												...
												<tr class="btm-border">
													<td><?=$countryConst=='SE'?'Grönt bidrag':'Green Sibsidy'?></td>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="first_name" data-error="Please enter <?=$countryConst=='SE'?'Förnamn':'First name'?>" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="last_name" data-error="Please enter <?=$countryConst=='SE'?'efternamn':'Last name'?>" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="address_input" id="address_input" data-error="Please enter <?=$countryConst=='SE'?'Adress':'Address'?>" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="postal_code" id="postal_code" data-error="Please enter <?=$countryConst=='SE'?'Postnummer':'Postal Code'?>" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="email" id="email" data-error="Please enter email" required>
										...
										<div class="col-md-6">
											<div class="form-group">
												<input type="text" name="phone" id="phone" data-error="Please enter <?=$countryConst=='SE'?'Telefon':'Phone'?>" required>
										...
										<div class="col-md-12">
											...
											<label class="form-check-label" for="exampleCheck1"><?=$countryConst=='SE'?'Jag accepterar Arka Energys villkor och att min personliga information behandlas i enlighet med gällande lagar.':'I accept Arka &apos; terms & conditions(consumption, production) and that my personal information is treatedin accordance with the laws that prevail Privacy Policy.'?></label>
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-9">
											<div class="calculator-get-started cntct_2_btn_inner text-right">
												...
												<button type="submit" class="submitForm1 nextbtn continue" id="calculatorSubmit" style="line-height:inherit"><?=$countryConst=='SE'?'Få offert':'Get a quote'?> <i class="fa fa-long-arrow-right"></i> </button>
											</div>
										</div>
									</div>
								</div>
