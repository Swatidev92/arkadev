...
.connect-form-box .captcha-input {
    width: 30% !important;
	height:38px;
	box-shadow:none;
}
						...
						<div class="connect-leftbox">
							<div class="wrapper_second_useful_2">
								<div class="connect-left-content">
									...
									<p><?=$countryConst=='SE'?'Vill du veta hur du sparar din elkostnad med mer än 80%?':'Do you want to know how to<br>save your business electricity<br>expense by more then 80%?'?></p>
							...
							<div class="connect-form-box">
								<div class="row">
									...
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="col-md-12">
											<select class="select21" id="customer_type" name="customer_type" required>
												...
												<?php if($countryConst=='SE'){
													$ctypeArr = $customerTypeArrSE;
												}else{
													$ctypeArr = $customerTypeArr;
												}
												foreach($ctypeArr as $ckey=>$cval){							
												?>
										...
										<div class="col-md-6">
											<input type="text" name="phone" placeholder="<?=$countryConst=='SE'?'Telefon':'Phone'?>" required>
										</div>
										<div class="clearfix"></div>
										<div class="col-md-12">
										...
										<div class="clearfix"></div>
										<div class="col-md-6">
											<input type="text" name="postal_code" placeholder="<?=$countryConst=='SE'?'Postnummer':'Postal Code'?>">
										</div>
										<div class="col-md-6">
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										<h2 class="connect-form-left-title"><?=$countryConst=='SE'?'':'Purpose'?></h2>
										<p class="connect-form-left-info"><?=$countryConst=='SE'?'Välj det som intresserar dig':'Select the purpose<br>that interests you'?></p>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="row">
											<div class="col-md-12">
												<input type="text" name="message" placeholder="<?=$countryConst=='SE'?'Övrig information':'Anything more we should to know?'?>">
											</div>
											<div class="col-md-12">
