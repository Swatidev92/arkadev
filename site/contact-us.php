            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
					<div class="sw_left_heading_wraper text-center">
						<h1><span class="heading-bold"><?=$countryConst=='SE'?'Kostnadsfri offert - Kontakta oss':'For free quotation - Contact us'?></span></h1>
					</div>
				</div>
			</div>					
						...
						<div class="contact-us-form">
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								<div class="form-group col-md-12">
									...
									<div class="checkbox">
										<label for="charging"><input type="checkbox" name="purpose[]" id="charging" value="Solar cells and the battery"><?=$countryConst=='SE'?'Solceller och batteri':'Solar cells and the battery'?></label>
									</div>
								</div>
								...
								<div class="form-group col-md-6">
									<input type="text" class="form-control" name="phone" placeholder="<?=$countryConst=='SE'?'Telefon':'Phone Number'?>" required>
								</div>
								<div class="clearfix"></div>
								<!--<div class="form-group col-md-12">
