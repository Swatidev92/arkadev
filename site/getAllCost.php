...
$totcost=0; $greenSubsidy=0; $netCost=0; $total_capacity=0; $annual_savings=0; $pvar=0; $upVar=0; $upfrontCost=''; $Inverter_cost=0; $installation_cost=0; $mms_cost=0; $panel_cost=0; $upfrontCostCharger=0; $upfrontCostBattery=0; $upfrontCostPanel=0;$solar_customer_price=0; $battery_customer_price=0; $charger_customer_price=0;
...
echo amount_format_proposal($final_price).'|'.amount_format_proposal($annual_savings);
