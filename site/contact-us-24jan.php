					...
					<form method="post" class="contact-form" onSubmit="return contactSubmission('contact-form','cmsg','submit-quote')">
						<div class="contact-us-form">
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								...
								<div class="form-group col-md-6">
									<input type="text" class="form-control" name="phone" placeholder="<?=$countryConst=='SE'?'Telefon':'Phone Number'?>" pattern="[0-9]{8,15}" required>
								</div>
								<div class="clearfix"></div>
								<div class="form-group col-md-12">
								...
								<div class="form-group col-md-12">
									...
									<div class="radio">
										<label for="social"><input type="radio" name="source" id="social" value="Social Media"><?=$countryConst=='SE'?'Sociala Medier':'Social Media'?></label>
									</div>
									<div class="radio">
										<label for="mailing"><input type="radio" name="source" id="mailing" value="Mailing"><?=$countryConst=='SE'?'Mailutskick':'Mailing'?></label>
									</div>
									<div class="radio">
										<label for="google"><input type="radio" name="source" id="google" value="Google">
										<?=$countryConst=='SE'?'Google':'Google'?></label>
									</div>
									<div class="radio">
										<label for="other"><input type="radio" name="source" id="other" value="Other">
										<?=$countryConst=='SE'?'Övrigt':'Other'?>Other</label>
									</div>
								</div>
								<div class="clearfix"></div>
								<div class="col-lg-12">
