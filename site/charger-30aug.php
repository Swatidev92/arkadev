            ...
            <div class="row">
				...
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
					<div class="btn-transparent text-center">
						<ul>
							<li>
								<a href="<?=$chargerRes['sec2_btn_link'.$langf]?>" class="green-border-btn"><?=$chargerRes['sec2_btn_text'.$langf]?></a>
							</li>
						</ul>
					</div>
				</div>
	...
	<div class="">
		<div class="row">
			<div class="col-md-6 no-padding">
				<img src="<?=SITE_PATH.'uploaded_files/charger/'.$chargerRes['sec8_img_left']?>" class="img-responsive">
			</div>
			<div class="col-md-6 no-padding">
				<img src="<?=SITE_PATH.'uploaded_files/charger/'.$chargerRes['sec8_img_right']?>" class="img-responsive">
			</div>
		</div>
	</div>
                ...
                <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
					...
					<div class="sw_nl_form_wrapper">
						<div class="disc_btn ltr_btn">
							<ul>
								<li>
									<a href="<?=$chargerRes['sec6_btn_link'.$langf]?>" class="" style="margin-top:30px;"><?=$chargerRes['sec6_btn_text'.$langf]?></a>
								</li>
							</ul>
						</div>
					</div>
            ...
            <div class="row">
				...
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
					<div class="disc_btn text-center">
						<ul>
							<li>
								<a href="<?=$chargerRes['sec7_btn_link'.$langf]?>" class="green-border-btn"><?=$chargerRes['sec7_btn_text'.$langf]?></a>
							</li>
						</ul>
					</div>
				</div>
	...
	<div class="">
		<div class="row">
			<div class="col-md-6 no-padding">
				<img src="<?=SITE_PATH.'uploaded_files/charger/'.$chargerRes['sec9_img_left']?>" class="img-responsive">
			</div>
			<div class="col-md-6 no-padding">
				<img src="<?=SITE_PATH.'uploaded_files/charger/'.$chargerRes['sec9_img_right']?>" class="img-responsive">
			</div>
		</div>
	</div>
