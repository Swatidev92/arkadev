	...
	<?php $homeQry = $cms->db_query("SELECT * FROM #_home ");
	$homeRes = $homeQry->fetch_array();
	?>

	<div class="page-head-banner" style="background: url(<?=SITE_PATH.'uploaded_files/home/'.$homeRes['banner']?>); background-position: center bottom; background-repeat: no-repeat; background-size: cover;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-8">
					<div class="content-banner">
						...
						<div class="banner-input-box">
							...
							<div class="row">
								<div class="col-md-5 col-xs-9 padding-right-none">
									<input type="text" name="ship-address" id="ship-address" placeholder="<?=$homeRes['address_placeholder'.$langf]?>" class="banner-address-input">
								</div>
								<div class="col-md-1 col-xs-3 padding-left-05">
									<a href=""> 
										<img src="<?=SITE_PATH?>assets/images/arrow/Green-Arrow-banner.svg" class="banner-green-btn">
									</a>
								</div>
							</div>
							</form>
                ...
                <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
					...
					<div class="sw_nl_form_wrapper">
						<div class="disc_btn ltr_btn">
							<ul>
								<li>
									<a href="<?=$homeRes['sec3_link'.$langf]?>" class=""><?=$homeRes['sec3_btn_text'.$langf]?></a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="">
		<div class="">
			<img src="<?=SITE_PATH.'uploaded_files/home/'.$homeRes['sec4_img'.$langf]?>" class="img-responsive" alt="title">
		</div>
	</div>
	...
	<div class="">
		<div class="">
			<img src="<?=SITE_PATH.'uploaded_files/home/'.$homeRes['sec7_img'.$langf]?>" class="img-responsive" alt="title">
		</div>
	</div>
