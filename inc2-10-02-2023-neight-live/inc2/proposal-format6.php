						...
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									...
									<tr>
										<td class="page6-heading-desc">Vid oförutsedda händelser så som ett i projekteringen icke uppäckt hinder på taket äger Arka Energy rätt att i samförstånd med kunden korrigera anläggningen mot prisavdrag på 2500 kronor per panel. Kunden informeras alltid om eventuella ändringar innan dessa utförs.</td>
									</tr>
								</tbody>					
							</table>
						</td>
