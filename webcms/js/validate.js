...
function submitions(vals){
	if(vals=="Active"){
		var ok = confirm("Are you sure to Active record?");
	}else if(vals=="Inactive"){
		var ok = confirm("Are you sure to Inactive record?");
	}else if(vals=="Assigned"){
		var ok = confirm("Are you sure to Assigned these records?");
	}else if(vals=="Featured"){
		var ok = confirm("Are you sure to Featured these records?");
	}else if(vals=="Unfeatured"){
		var ok = confirm("Are you sure to Unfeatured these records?");
	}else if(vals=="Publish"){
		var ok = confirm("Are you sure to Publish these records?");
	}else if(vals=="Unpublish"){
		var ok = confirm("Are you sure to Unpublish these records?");
	}else{
		var ok = confirm("Are you sure to Delete record?");
	}
	
	if (!ok) {
		document.aforms.reset();
		return false;	
	}else{
