								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultTwo" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										...
										<div class="col-sm-6">											
											...
											<input type="text" name="sec1_btn_link" value="<?=$sec1_btn_link?>" class="form-control" id="sec1_btn_link" required> 
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
							...
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultThree" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										...
										<div class="col-sm-4">
											<label for="sec2_img1" class="control-label">Image 1</label>
											...
											<label for="sec2_panel1" class="control-label">Panel 1*</label>
											<input type="text" name="sec2_panel1" value="<?=$sec2_panel1?>" class="form-control" id="sec2_panel1" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity1" class="control-label">Panel Capacity 1*</label>
											<input type="text" name="panel_capacity1" value="<?=$panel_capacity1?>" class="form-control" id="panel_capacity1" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
										</div>
										<div class="col-sm-4">
											<label for="sec2_img2" class="control-label">Image 2</label>
											...
											<label for="sec2_panel2" class="control-label">Panel 2*</label>
											<input type="text" name="sec2_panel2" value="<?=$sec2_panel2?>" class="form-control" id="sec2_panel2" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity2" class="control-label">Panel Capacity 2*</label>
											<input type="text" name="panel_capacity2" value="<?=$panel_capacity2?>" class="form-control" id="panel_capacity2" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
										</div>
										<div class="col-sm-4">
											<label for="sec2_img3" class="control-label">Image 3</label>
											...
											<label for="sec2_panel3" class="control-label">Panel 3*</label>
											<input type="text" name="sec2_panel3" value="<?=$sec2_panel3?>" class="form-control" id="sec2_panel3" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity3" class="control-label">Panel Capacity 3*</label>
								...
								<div class="panel-collapse collapse" id="solarTwoSW" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										...
										<div class="col-sm-6">											
											...
											<input type="text" name="sec1_btn_link_sw" value="<?=$sec1_btn_link_sw?>" class="form-control" id="sec1_btn_link_sw" required> 
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
								...
								<div class="panel-collapse collapse" id="solarThreeSW" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										...
										<div class="col-sm-4">											
											...
											<label for="sec2_panel1_sw" class="control-label">Panel 1*</label>
											<input type="text" name="sec2_panel1_sw" value="<?=$sec2_panel1_sw?>" class="form-control" id="sec2_panel1_sw" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity1_sw" class="control-label">Panel Capacity 1*</label>
											<input type="text" name="panel_capacity1_sw" value="<?=$panel_capacity1_sw?>" class="form-control" id="panel_capacity1_sw" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
										</div>
										<div class="col-sm-4">											
											...
											<label for="sec2_panel2_sw" class="control-label">Panel 2*</label>
											<input type="text" name="sec2_panel2_sw" value="<?=$sec2_panel2_sw?>" class="form-control" id="sec2_panel2_sw" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity2_sw" class="control-label">Panel Capacity 2*</label>
											<input type="text" name="panel_capacity2_sw" value="<?=$panel_capacity2_sw?>" class="form-control" id="panel_capacity2_sw" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
										</div>
										<div class="col-sm-4">											
											...
											<label for="sec2_panel3_sw" class="control-label">Panel 3*</label>
											<input type="text" name="sec2_panel3_sw" value="<?=$sec2_panel3_sw?>" class="form-control" id="sec2_panel3_sw" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
											
											<label for="panel_capacity3_sw" class="control-label">Panel Capacity 3*</label>
