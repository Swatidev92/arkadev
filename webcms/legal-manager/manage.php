				...
				<div role="tabpanel" class="tab-pane fade active in" id="eng">
					<div class="form-group">
								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultTwo" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">										
										...
										<div class="col-sm-6">
											...
											<select class="form-control" name="btn_link" id="btn_link">
												<option value="">Select Page</option>
												<?php $pageQrySe = $cms->db_query("SELECT id, menu_title FROM #_menu LIMIT 10 ");
													while($pageArrSe = $pageQrySe->fetch_array()){
												?>												
												<option value="<?=$pageArrSe['id']?>" <?=$pageArrSe['id']==$btn_link?'selected':''?>><?=$pageArrSe['menu_title']?></option>
													<?php } ?>
											</select> 
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								<div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab"> 
									<a class="panel-title collapsed" data-toggle="collapse" href="#legalMeta" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="legalMeta">Meta Manager</a> 
								</div>
								<div class="panel-collapse collapse" id="legalMeta" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
				...
				<div role="tabpanel" class="tab-pane fade" id="swe">
					<div class="form-group">
								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultTwosw" aria-labelledby="exampleCollapseDefaultTwosw" role="tabpanel">
									<div class="panel-body">										
										...
										<div class="col-sm-6">
											...
											<select class="form-control" name="btn_link_sw" id="btn_link_sw">
												<option value="">Select Page</option>
												<?php $pageQrySe = $cms->db_query("SELECT id, menu_title_sw FROM #_menu LIMIT 10 ");
													while($pageArrSe = $pageQrySe->fetch_array()){
												?>												
												<option value="<?=$pageArrSe['id']?>" <?=$pageArrSe['id']==$btn_link_sw?'selected':''?>><?=$pageArrSe['menu_title_sw']?></option>
													<?php } ?>
											</select> 
											<div class="help-block with-errors"></div>
										</div>
						...
						<<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								<div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab"> 
									<a class="panel-title collapsed" data-toggle="collapse" href="#legalMetaSW" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="legalMetaSW">Meta Manager</a> 
								</div>
								<div class="panel-collapse collapse" id="legalMetaSW" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										<div class="form-group col-sm-12">											
