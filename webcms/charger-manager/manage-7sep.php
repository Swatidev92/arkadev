						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="chargerAcc9" aria-labelledby="exampleHeadingDefaultNine" role="tabpanel">
									<div class="panel-body">
										<div class="form-group col-sm-6">
											<label for="sec8_img_left" class="control-label">Left Image</label>
										...
										<div class="form-group col-sm-6">
											<label for="sec8_img_right" class="control-label">Right Image</label>
							...
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleHeadingDefaultTen" aria-labelledby="exampleHeadingDefaultTen" role="tabpanel">
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">											
											<label for="sec5_right_img" class="control-label">Image</label>
								...
								<div class="panel-collapse collapse" id="sec6AccEng" aria-labelledby="exampleHeadingDefaulteleven" role="tabpanel">
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">
											...
											<input type="text" name="sec7_btn_link" value="<?=$sec7_btn_link?>" class="form-control" id="sec7_btn_link" data-fv-regexp="true" data-error="Please enter value" required> 
											<div class="help-block with-errors"></div>
										</div>
										<div class="clearfix"></div>
									</div>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="chagerAcc10" aria-labelledby="exampleHeadingDefaultFour" role="tabpanel">
									<div class="panel-body">
										<div class="col-sm-6">
											<label for="sec9_img_left" class="control-label">Left Image</label>
										...
										<div class="col-sm-6">
											<label for="sec9_img_right" class="control-label">Right Image</label>
