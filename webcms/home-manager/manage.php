				...
				<div role="tabpanel" class="tab-pane fade active in" id="eng">
					<div class="form-group">
							...
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultThree" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">
											<label for="sec2_img" class="control-label">Right Image (652px X 434px) (Only jpg, png)</label>
								...
								<div class="panel-collapse collapse" id="exampleHeadingDefaultFour" aria-labelledby="exampleHeadingDefaultFour" role="tabpanel">
									<div class="panel-body">
										<div class="col-sm-6">
											...
											<select class="form-control" name="sec3_link" id="sec3_link">
												<option value="">Select Page</option>
												<?php $pageQry = $cms->db_query("SELECT id, menu_title FROM #_menu LIMIT 10 ");
													while($pageArr = $pageQry->fetch_array()){
												?>												
												<option value="<?=$pageArr['id']?>" <?=$pageArr['id']==$sec3_link?'selected':''?>><?=$pageArr['menu_title']?></option>
													<?php } ?>
											</select>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleHeadingDefaultFive" aria-labelledby="exampleHeadingDefaultFive" role="tabpanel">
									<div class="panel-body">
										<div class="form-group col-sm-6">
											<label for="sec4_img" class="control-label">Image (1440px X 696px) (Only jpg, png)</label>
							...
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleCollapseDefaultSeven" aria-labelledby="exampleCollapseDefaultSeven" role="tabpanel">
									<div class="panel-body">
										...
										<div class="col-sm-6">
											<label for="sec6_right_img" class="control-label">Right Image (265px X 500px) (Only jpg, png)</label>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								...
								<div class="panel-collapse collapse" id="exampleHeadingDefaultEight" aria-labelledby="exampleHeadingDefaultEight" role="tabpanel">
									<div class="panel-body">
										<div class="form-group col-sm-6">
											<label for="sec7_img" class="control-label">Image (1440px X 500px) (Only jpg, png)</label>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								<div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab"> 
									<a class="panel-title collapsed" data-toggle="collapse" href="#homeMeta" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="homeMeta">Meta Manager</a> 
								</div>
								<div class="panel-collapse collapse" id="homeMeta" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
				...
				<div role="tabpanel" class="tab-pane fade" id="swe">
					<div class="form-group">
								...
								<div class="panel-collapse collapse" id="homeCollapseFourSw" aria-labelledby="homeCollapseFourSw" role="tabpanel">
									<div class="panel-body">
										<div class="col-sm-6">
											...
											<select class="form-control" name="sec3_link_sw" id="sec3_link_sw">
												<option value="">Select Page</option>
												<?php $pageQrySe = $cms->db_query("SELECT id, menu_title_sw FROM #_menu LIMIT 10 ");
													while($pageArrSe = $pageQrySe->fetch_array()){
												?>												
												<option value="<?=$pageArrSe['id']?>" <?=$pageArrSe['id']==$sec3_link_sw?'selected':''?>><?=$pageArrSe['menu_title_sw']?></option>
													<?php } ?>
											</select>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="panel-group" id="exampleAccordionDefault" aria-multiselectable="true" role="tablist">
							<div class="panel">
								<div class="panel-heading" id="exampleHeadingDefaultTwo" role="tab"> 
									<a class="panel-title collapsed" data-toggle="collapse" href="#homeMetaSW" data-parent="#exampleAccordionDefault" aria-expanded="false" aria-controls="homeMetaSW">Meta Manager</a> 
								</div>
								<div class="panel-collapse collapse" id="homeMetaSW" aria-labelledby="exampleHeadingDefaultTwo" role="tabpanel">
									<div class="panel-body">
										<div class="form-group col-sm-12">											
