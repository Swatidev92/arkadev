		...
		<ul class="nav" id="side-menu">
			...
			<li><a href="javascript:void(0)" class="waves-effect">
				...
				<ul class="nav nav-second-level">
					<li><a href="<?=SITE_PATH_ADM?>lead-manager"><i class="ti-support fa-fw"></i> Manage leads</a></li>
					<?php if($_SESSION["ses_adm_role"]==1){?>
					<li><a href="<?=SITE_PATH_ADM?>user-manager"><i class="ti-support fa-fw"></i> Agent Manager</a></li>
					<li><a href="<?=SITE_PATH_ADM?>customer-price-manager"><i class="ti-support fa-fw"></i> Customer Price Manager</a></li>	<?php } ?>
				</ul>
			</li>
			<?php if($_SESSION["ses_adm_role"]==1){?>
			<li> 
