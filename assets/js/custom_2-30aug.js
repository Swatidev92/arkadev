...
//Single page scroll js for button
	...
	$(document).ready(function() {
              $('.spectrum_slider_wrapper .owl-carousel').owlCarousel({
				...
				smartSpeed: 1200,
                responsiveClass: true,
				navText : ['<img src="https://arkaenergy.se/demo/assets/images/arrow/left-arrow.svg">','<img src="https://arkaenergy.se/demo/assets/images/arrow/right-arrow-green.svg">'],
                responsive: {
                  0: {
                    items: 1,
                    nav: true
	...
	$(document).ready(function() {
		...
		$(document).ready(function() {
            $('.charger_slider .owl-carousel').owlCarousel({
                loop: true,
                margin: 0,
                autoplay: true,
                responsiveClass: true,
