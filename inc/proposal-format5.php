		...
		<div class="block">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="bigimage">
				<tbody>
							...
							<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									<tr>
										...
										<td style="text-align:center;"><?=proposal_decimal_format($system_size/1000)?> kWp</td>
									</tr>
									<tr>
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="4" border="0" class="devicewidth" modulebg="edit" style="background:#fff; border-top: 1px solid #000;">
								<tbody>
									<tr>
										<td style="text-align:left; font-size:12px;">
					...
					<tr>
						<td>
							<table width="100%" align="center" cellspacing="0" cellpadding="2" border="0" class="devicewidth" modulebg="edit" style="background:#fff">
								<tbody>
									<tr>
										<td style="text-align:left;">*Förutsätter internetuppkoppling till växelriktare i form av WiFi.</td>
									</tr>
									<tr>
										<td style="text-align:left;">**Grönt avdrag är 15% av totalbelopp menomfattar enbart material & arbetskostnader. Schablon är satt av Skatteverket till 14,55%. För mer information om bidraget och dess villkor, läs mer på <a href="https://www.skatteverket.se/">www.skatteverket.se</a></td>
									</tr>
									<?php if($charger_name!=''){?>
									<tr>
										<td style="text-align:left;">***Grönt avdrag är 50% av totalbelopp menomfattar enbart material & arbetskostnader. Schablon är satt av Skatteverket till 48,5%.För mer information om bidraget och dess villkor,läs mer på <a href="https://www.skatteverket.se/">www.skatteverket.se</a></td>
									</tr>
									<?php } ?>
								</tbody>
							</table>
